  ...
  })(
    {
            ...
            (i["default"] = function(e) {
              function t() {
                C &&
                  ...
                  (i.globalAlpha = 1),
                  l.isCanvasSupported &&
                    (n.lineTo(y, M), n.lineTo(C.x, M), n.closePath(), n.fill()),
                  i.beginPath(),
                  i.moveTo(y, f),
                  n.beginPath(),
                  n.moveTo(y, f),
              ...
              var i = e.targetCanvasCtx || this.plotArea.ctx,
                a = e.dataSeriesIndexes.length;
              if (!(0 >= a)) {
                var n = this._eventManager.ghostCtx,
                  r = e.axisX.lineCoordinates,
                  h = e.axisY.lineCoordinates,
                  d = [],
                  c = this.plotArea;
                i.save(),
                  l.isCanvasSupported && n.save(),
                  i.beginPath(),
                  ...
                  l.isCanvasSupported &&
                    ...
                    n.clip());
                for (var p = 0; p < e.dataSeriesIndexes.length; p++) {
                  var x = e.dataSeriesIndexes[p],
                    u = this.data[x],
                    m = u.dataPoints,
                    v = u.id;
                  ...
                  var g = (0, l.intToHexColorString)(v);
                  (n.fillStyle = g), (d = []);
                  var y,
                    f,
                    b,
                    ...
                    C = null;
                  if (m.length > 0) {
                    var k = u._colorSet[S % u._colorSet.length];
                    (i.fillStyle = k),
                      (i.strokeStyle = k),
                    ...
                    for (var w = !0; S < m.length; S++)
                      if (
                        ((b = m[S].x.getTime ? m[S].x.getTime() : m[S].x),
                        !(
                          b < e.axisX.dataInfo.viewPortMin ||
                          b > e.axisX.dataInfo.viewPortMax
                        ))
                      )
                        if ("number" == typeof m[S].y) {
                          (y =
                            (e.axisX.conversionParameters.reference +
                              e.axisX.conversionParameters.pixelPerUnit *
                                (b - e.axisX.conversionParameters.minimum) +
                              0.5) <<
                            0),
                            (f =
                              (e.axisY.conversionParameters.reference +
                            ...
                            P || w
                              ? (i.beginPath(),
                                ...
                                (C = { x: y, y: f }),
                                l.isCanvasSupported &&
                                  (n.beginPath(), n.moveTo(y, f)),
                                (P = !1),
                                (w = !1))
                              : (i.lineTo(y, f),
                                l.isCanvasSupported && n.lineTo(y, f),
                                S % 250 == 0 && t());
                          var _ = u.dataPointIds[S];
                          if (
                            ...
                            0 !== m[S].markerSize &&
                              (m[S].markerSize > 0 || u.markerSize > 0))
                          ) {
                            var A = u.getMarkerProperties(S, y, f, i);
                            d.push(A);
                            var L = (0, l.intToHexColorString)(_);
                            l.isCanvasSupported &&
                              d.push({
                                x: y,
                                y: f,
                          ...
                          (m[S].indexLabel ||
                            ...
                            this._indexLabels.push({
                              ...
                              dataSeries: u,
                              point: { x: y, y: f },
                              direction: m[S].y >= 0 ? 1 : -1,
                              color: k
                            });
                        } else t(), (w = !0);
                    t(), s["default"].drawMarkers(d);
                  }
                }
                i.restore(),
              ...
              if (!(0 >= i)) {
                var a,
                  ...
                  p = this.dataPointMaxWidth
                    ...
                    : Math.min(
                        0.15 * this.height,
                        this.plotArea.height / e.plotType.totalDataSeries * 0.9
                      ) << 0,
                ...
                u > p
                  ? (u = p)
                  : x === 1 / 0
                    ? (u = p / e.plotType.totalDataSeries * 0.9)
                    : 1 > u && (u = 1),
                  t.save(),
                  r.isCanvasSupported && this._eventManager.ghostCtx.save(),
                  t.beginPath(),
                ...
                for (var m = 0; m < e.dataSeriesIndexes.length; m++) {
                  var v = e.dataSeriesIndexes[m],
                    ...
                    y = g.dataPoints;
                  if (y.length > 0) {
                    var f = u > 5 && g.bevelEnabled ? !0 : !1;
                    for (t.strokeStyle = "#4572A7 ", d = 0; d < y.length; d++)
                      if (
                        ((o = y[d].getTime ? y[d].x.getTime() : y[d].x),
                        !(
                          o < e.axisX.dataInfo.viewPortMin ||
                          o > e.axisX.dataInfo.viewPortMax
                        ) && "number" == typeof y[d].y)
                      ) {
                        (n =
                          (e.axisX.conversionParameters.reference +
                            e.axisX.conversionParameters.pixelPerUnit *
                              (o - e.axisX.conversionParameters.minimum) +
                            0.5) <<
                          0),
                          (a =
                            (e.axisY.conversionParameters.reference +
                        ...
                        var b,
                          ...
                          P =
                            (n -
                              e.plotType.totalDataSeries * u / 2 +
                              (e.previousDataSeriesCount + m) * u) <<
                            0,
                          S = (P + u) << 0;
                        y[d].y >= 0 ? ((b = c), (M = a)) : ((b = a), (M = c)),
                          (l = y[d].color
                            ? y[d].color
                ...
                t.restore(),
                  r.isCanvasSupported && this._eventManager.ghostCtx.restore();
                var C = Math.max(c, e.axisX.boundingRect.x2),
                  k = {
                    source: t,
                    dest: this.plotArea.ctx,
                    animationCallback: s["default"].xScaleAnimation,
                    easingFunction: s["default"].easing.easeOutQuart,
                    animationBase: C
                  };
                return k;
              }
            ...
            (i["default"] = function(e) {
              ...
              if (!(0 >= i)) {
                var a,
                  ...
                  d = this.plotArea,
                  c = 0,
                  p = ((e.axisY.conversionParameters.reference +
                    e.axisY.conversionParameters.pixelPerUnit *
                      (0 - e.axisY.conversionParameters.minimum)) <<
                    0,
                  this.dataPointMaxWidth
                ...
                for (
                  var m = -(1 / 0), v = 1 / 0, g = 0;
                  g < e.dataSeriesIndexes.length;
                  g++
                )
                  for (
                    var y = e.dataSeriesIndexes[g],
                      f = this.data[y],
                      b = f.dataPoints,
                      M = 0,
                      c = 0;
                    ...
                    (r = r = b[c].getTime ? b[c].x.getTime() : b[c].x),
                      r < e.axisX.dataInfo.viewPortMin ||
                        r > e.axisX.dataInfo.viewPortMax ||
                        ("undefined" != typeof b[c].z &&
                          ((M = b[c].z), M > m && (m = M), v > M && (v = M)));
                for (
                  var P = 5 * Math.PI * 5,
                    S = Math.max(
                      Math.pow(0.25 * Math.min(d.height, d.width) / 2, 2) *
                        Math.PI,
                      P
                    ),
                    g = 0;
                      ...
                      if (
                        ...
                        (a =
                          ...
                          (n =
                            ...
                            0);
                        var M = b[c].z,
                          T = m === v ? S / 2 : P + (S - P) / (m - v) * (M - v),
                          C = Math.max(Math.sqrt(T / Math.PI) << 0, 1),
                          k = 2 * C,
                          w = f.getMarkerProperties(c, t);
                        (w.size = k),
                          (t.globalAlpha = f.fillOpacity),
                        ...
                        var A = (0, l.intToHexColorString)(_);
                        l.isCanvasSupported &&
                          s["default"].drawMarker(
                            a,
                            n,
            ...
            (i["default"] = function(e) {
              ...
              if (!(0 >= n)) {
                var s,
                  ...
                  p = this.plotArea,
                  x = 0,
                  u = ((e.axisY.conversionParameters.reference +
                    e.axisY.conversionParameters.pixelPerUnit *
                      (0 - e.axisY.conversionParameters.minimum)) <<
                    0,
                  this.dataPointMaxWidth
                  ...
                  v =
                    (p.width /
                      ...
                      0.7) <<
                    0;
                v > u ? (v = u) : m === 1 / 0 ? (v = u) : 1 > v && (v = 1),
                  t.save(),
                  a.isCanvasSupported && i.save(),
                  t.beginPath(),
                  t.rect(p.x1, p.y1, p.width, p.height),
                  t.clip(),
                  a.isCanvasSupported &&
                    (i.rect(p.x1, p.y1, p.width, p.height), i.clip());
                for (var g = 0; g < e.dataSeriesIndexes.length; g++) {
                  var y = e.dataSeriesIndexes[g],
                    f = this.data[y],
                    b = f.dataPoints;
                  if (b.length > 0) {
                    var M = v > 5 && f.bevelEnabled ? !0 : !1;
                    for (x = 0; x < b.length; x++)
                      if (
                        ((d = b[x].getTime ? b[x].x.getTime() : b[x].x),
                        !(
                          d < e.axisX.dataInfo.viewPortMin ||
                          d > e.axisX.dataInfo.viewPortMax
                        ) &&
                          null !== b[x].y &&
                          b[x].y.length &&
                          "number" == typeof b[x].y[0] &&
                          "number" == typeof b[x].y[1] &&
                          "number" == typeof b[x].y[2] &&
                          "number" == typeof b[x].y[3])
                      ) {
                        (s =
                          (e.axisX.conversionParameters.reference +
                            e.axisX.conversionParameters.pixelPerUnit *
                              (d - e.axisX.conversionParameters.minimum) +
                            0.5) <<
                          0),
                          (r =
                            (e.axisY.conversionParameters.reference +
                        ...
                        var P = (s - v / 2) << 0,
                          S = (P + v) << 0;
                        c = b[x].color ? b[x].color : f._colorSet[0];
                        var T = Math.round(Math.max(1, 0.15 * v)),
                          C = T % 2 === 0 ? 0 : 0.5,
                          k = f.dataPointIds[x];
                        (this._eventManager.objectMap[k] = {
                          ...
                          t.beginPath(),
                          (t.lineWidth = T),
                          (i.lineWidth = Math.max(T, 4)),
                          "candlestick" === f.type
                            ? (t.moveTo(s - C, o),
                              t.lineTo(s - C, Math.min(r, h)),
                              t.stroke(),
                              t.moveTo(s - C, Math.max(r, h)),
                              t.lineTo(s - C, l),
                              t.stroke(),
                              drawRect(
                                t,
                                ...
                                S,
                                Math.max(r, h),
                                b[x].y[0] <= b[x].y[3] ? f.risingColor : c,
                                T,
                                c,
                                M,
                                M,
                              ...
                              a.isCanvasSupported &&
                                ((c = intToHexColorString(k)),
                                (i.strokeStyle = c),
                                i.moveTo(s - C, o),
                                i.lineTo(s - C, Math.min(r, h)),
                                i.stroke(),
                                i.moveTo(s - C, Math.max(r, h)),
                                i.lineTo(s - C, l),
                                i.stroke(),
                                drawRect(
                                  i,
                ...
                t.restore(), a.isCanvasSupported && i.restore();
                var w = {
                  source: t,
                  dest: this.plotArea.ctx,
          ...
          Object.defineProperty(i, "__esModule", { value: !0 }),
            (i["default"] = function(e) {
              ...
              if (!(0 >= i)) {
                ...
                t.restore(),
                  r.isCanvasSupported && this._eventManager.ghostCtx.restore();
                var C = Math.min(c, e.axisY.boundingRect.y2),
                  k = {
                    source: t,
                    dest: this.plotArea.ctx,
                    animationCallback: s["default"].yScaleAnimation,
                    easingFunction: s["default"].easing.easeOutQuart,
                    animationBase: C
                  };
                return k;
      ...
      6: [
        function(e, t, i) {
          ...
          Object.defineProperty(i, "__esModule", { value: !0 }),
            (i.PieChart = i.RangeSplineAreaChart = i.RangeAreaChart = i.RangeBarChart = i.RangeColumnChart = i.CandlestickChart = i.ScatterChart = i.BubbleChart = i.StackedArea100Chart = i.StackedAreaChart = i.StepAreaChart = i.SplineAreaChart = i.AreaChart = i.StackedBar100Chart = i.StackedBarChart = i.BarChart = i.StackedColumn100Chart = i.StackedColumnChart = i.ColumnChart = i.SplineChart = void 0);
        ...
        function(e, t, i) {
          ...
          Object.defineProperty(i, "__esModule", { value: !0 }),
            (i["default"] = function(e) {
                ...
                if (g && y) {
                  ...
                  for (L = 0; L < y.length; L++) {
                    ...
                    var l = { percent: null, total: null },
                      h = null;
                    (l = u.getPercentAndTotal(g, n)),
                      (g.indexLabelFormatter || n.indexLabelFormatter) &&
                        (h = {
                          chart: u._options,
                          dataSeries: g,
                          dataPoint: n,
                    ...
                    var d = n.indexLabelFormatter
                      ? n.indexLabelFormatter(h)
                      : n.indexLabel
                        ? u.replaceKeywordsWithValue(n.indexLabel, n, g, L)
                        : g.indexLabelFormatter
                          ? g.indexLabelFormatter(h)
                          : g.indexLabel
                            ? u.replaceKeywordsWithValue(g.indexLabel, n, g, L)
                            : n.label
                              ? n.label
                              : "";
                    (u._eventManager.objectMap[r] = o),
                      (o.center = { x: w.x, y: w.y }),
                      (o.y = n.y),
                      (o.radius = I),
                      (o.percentInnerRadius = F),
                      (o.indexLabelText = d),
                      (o.indexLabelPlacement = g.indexLabelPlacement),
                      (o.indexLabelLineColor = n.indexLabelLineColor
                        ? n.indexLabelLineColor
                        : g.indexLabelLineColor
                          ? g.indexLabelLineColor
                          : n.color
                            ? n.color
                            : g._colorSet[L % g._colorSet.length]),
                      (o.indexLabelLineThickness = n.indexLabelLineThickness
                      ...
                      (o.indexLabelFontFamily = n.indexLabelFontFamily
                        ? n.indexLabelFontFamily
                        : g.indexLabelFontFamily),
                      (o.indexLabelBackgroundColor = n.indexLabelBackgroundColor
                        ? n.indexLabelBackgroundColor
                        : g.indexLabelBackgroundColor
                          ? g.indexLabelBackgroundColor
                          : null),
                      (o.indexLabelMaxWidth = n.indexLabelMaxWidth
                        ? n.indexLabelMaxWidth
                        : g.indexLabelMaxWidth
                          ? g.indexLabelMaxWidth
                          : 0.33 * M.width),
                      (o.indexLabelWrap =
                        "undefined" != typeof n.indexLabelWrap
                          ? n.indexLabelWrap
                          : g.indexLabelWrap),
                      (o.startAngle =
                        0 === L
                      ...
                      (o.endAngle =
                        o.startAngle + 2 * Math.PI / _ * Math.abs(n.y));
                    var c = (o.endAngle + o.startAngle) / 2;
                    (c = (c + 2 * Math.PI) % (2 * Math.PI)),
                      (o.midAngle = c),
                      o.midAngle > Math.PI / 2 - C &&
                      o.midAngle < Math.PI / 2 + C
                        ? ((0 === e || P[i].midAngle > o.midAngle) && (i = L),
                          e++)
                        : o.midAngle > 3 * Math.PI / 2 - C &&
                          o.midAngle < 3 * Math.PI / 2 + C &&
                          ((0 === t || P[a].midAngle > o.midAngle) && (a = L),
                          t++),
                      c > Math.PI / 2 && c <= 3 * Math.PI / 2
                        ? (o.hemisphere = "left")
                        : (o.hemisphere = "right"),
                      (o.indexLabelTextBlock = new s["default"](
                        u.plotArea.ctx,
                        {
                  ...
                  var p = 0,
                    ...
                    m = !1;
                  for (L = 0; L < y.length; L++) {
                    var o = P[(i + L) % y.length];
                    e > 1 &&
                      o.midAngle > Math.PI / 2 - C &&
                      o.midAngle < Math.PI / 2 + C &&
                      (e / 2 >= p && !m
                        ? ((o.hemisphere = "right"), p++)
                        : ((o.hemisphere = "left"), (m = !0)));
                  }
                  for (m = !1, L = 0; L < y.length; L++) {
                    var o = P[(a + L) % y.length];
                    t > 1 &&
                      o.midAngle > 3 * Math.PI / 2 - C &&
                      o.midAngle < 3 * Math.PI / 2 + C &&
                      (t / 2 >= x && !m
                        ? ((o.hemisphere = "left"), x++)
                        : ((o.hemisphere = "right"), (m = !0)));
                  }
                }
              }
              function i() {
                var e = u.plotArea.ctx;
                ...
                for (t = 0; t < y.length; t++) {
                  ...
                  if (i.indexLabelText) {
                    ...
                    if (
                      ...
                      var n = i.center.x + I * Math.cos(i.midAngle),
                        s = i.center.y + I * Math.sin(i.midAngle);
                      (e.strokeStyle = i.indexLabelLineColor),
                        (e.lineWidth = i.indexLabelLineThickness),
                        e.setLineDash &&
                          e.setLineDash(
                            (0, r.getLineDashArray)(
              ...
              function a(e) {
                var t = u.plotArea.ctx;
                t.clearRect(M.x1, M.y1, M.width, M.height),
                  (t.fillStyle = u.backgroundColor),
                  t.fillRect(M.x1, M.y1, M.width, M.height);
                for (
                  var i = P[0].startAngle + 2 * Math.PI * e, a = 0;
                  a < y.length;
                  a++
                ) {
                  var n = 0 === a ? P[a].startAngle : s,
                    s = n + (P[a].endAngle - P[a].startAngle),
                    o = !1;
                  s > i && ((s = i), (o = !0));
                  var l = y[a].color
                    ? y[a].color
                    : g._colorSet[a % g._colorSet.length];
                  if (
                    (s > n &&
                      (0, r.drawSegment)(
                        u.plotArea.ctx,
              ...
              function n(e) {
                ...
                for (var a = 0; a < y.length; a++) {
                  var n = P[a].startAngle,
                    s = P[a].endAngle;
                  if (s > n) {
                    var o = 0.07 * I * Math.cos(P[a].midAngle),
                      l = 0.07 * I * Math.sin(P[a].midAngle),
                      h = !1;
                    if (
                      (y[a].exploded
                        ? (Math.abs(P[a].center.x - (w.x + o)) > 1e-9 ||
                            Math.abs(P[a].center.y - (w.y + l)) > 1e-9) &&
                          ((P[a].center.x = w.x + o * e),
                          (P[a].center.y = w.y + l * e),
                          (h = !0))
                        : (Math.abs(P[a].center.x - w.x) > 0 ||
                            Math.abs(P[a].center.y - w.y) > 0) &&
                          ((P[a].center.x = w.x + o * (1 - e)),
                          (P[a].center.y = w.y + l * (1 - e)),
                          (h = !0)),
                      h)
                    ) {
                      var d = {};
                      (d.dataSeries = g),
                        (d.dataPoint = g.dataPoints[a]),
                        (d.index = a),
                        u._toolTip.highlightObjects([d]);
                    }
                    var c = y[a].color
                      ? y[a].color
                      : g._colorSet[a % g._colorSet.length];
              ...
              function o(e, t) {
                var i = {
                    ...
                    y2:
                      e.indexLabelTextBlock.y + e.indexLabelTextBlock.height / 2
                  },
                  a = {
              ...
              function l(e, t) {
                ...
                return (i = n.y > a.y ? n.y1 - a.y2 : a.y1 - n.y2);
              }
              function h(e) {
                for (var t = null, i = 1; i < y.length; i++) {
                  if (
                    ((t = (e + i + P.length) % P.length),
                    P[t].hemisphere !== P[e].hemisphere)
                  ) {
                    t = null;
                    break;
                  }
                  if (
                    ...
                    t !== e &&
                    (l(P[t], P[e]) < 0 ||
                      ("right" === P[e].hemisphere
                        ? P[t].indexLabelTextBlock.y >=
                          P[e].indexLabelTextBlock.y
                        : P[t].indexLabelTextBlock.y <=
                          P[e].indexLabelTextBlock.y))
                  )
                    break;
              ...
              function c(e, t) {
                t = t || 0;
                var i = 0,
                  a = w.y - 1 * indexLabelRadius,
                  n = w.y + 1 * indexLabelRadius;
                if (e >= 0 && e < y.length) {
                  var s = P[e];
                  if (
                    (0 > t && s.indexLabelTextBlock.y < a) ||
                  ...
                  (v =
                    "right" === s.hemisphere
                      ? w.x +
                        Math.sqrt(
                          Math.pow(indexLabelRadius, 2) - Math.pow(m - w.y, 2)
                        )
                      : w.x -
                        Math.sqrt(
                          Math.pow(indexLabelRadius, 2) - Math.pow(m - w.y, 2)
                        )),
                    (l = w.x + I * Math.cos(s.midAngle)),
                    (p = w.y + I * Math.sin(s.midAngle)),
                    (o = Math.sqrt(Math.pow(v - l, 2) + Math.pow(m - p, 2))),
                    (u = Math.acos(I / indexLabelRadius)),
                    (x = Math.acos(
                      (indexLabelRadius * indexLabelRadius + I * I - o * o) /
                        (2 * I * indexLabelRadius)
                    )),
                    (r = u > x ? m - s.indexLabelTextBlock.y : 0);
                  var g,
                    f,
                    b = d(e),
                    M = h(e),
                    ...
                    if (
                      ...
                      var A = -r,
                        f =
                          s.indexLabelTextBlock.y -
                          s.indexLabelTextBlock.height / 2 -
                          (P[g].indexLabelTextBlock.y +
                            P[g].indexLabelTextBlock.height / 2);
                      S > f - A &&
                        ((T = -A),
                        (_ = c(g, T, recursionCount + 1)),
                        +_.toFixed(k) > +T.toFixed(k) &&
                          (i = f > S ? -(f - S) : -(A - (_ - T))));
                    }
                  } else if (
                    r > 0 &&
                    ((g = "right" === s.hemisphere ? M : b),
                    (i = r),
                    null !== g)
                  ) {
                    var A = r,
                  ...
                  if (i) {
                    var L = s.indexLabelTextBlock.y + i,
                      B = 0;
                    if (
                      ((B =
                        "right" === s.hemisphere
                      ...
                      s.midAngle > Math.PI / 2 - C &&
                        s.midAngle < Math.PI / 2 + C)
                    ) {
                      var F = (e - 1 + P.length) % P.length,
                        z = P[F],
                        D = P[(e + 1 + P.length) % P.length];
                      "left" === s.hemisphere &&
                      "right" === z.hemisphere &&
                    ...
                    (s.indexLabelTextBlock.y = L),
                      (s.indexLabelTextBlock.x = B),
                      (s.indexLabelAngle = Math.atan2(
                        s.indexLabelTextBlock.y - w.y,
                        s.indexLabelTextBlock.x - w.x
                      ));
                  }
                }
                return i;
              ...
              function p() {
                ...
                var t = 16;
                (e.font = t + "px Arial"), (e.textBaseline = "middle");
                var i = 0,
                  a = 0,
                  n = 0,
                  s = !0,
                  r = function() {
                    ...
                    if (
                      ((g.radius ||
                        (!g.radius &&
                          "undefined" != typeof g.innerRadius &&
                          null !== g.innerRadius &&
                          B >= I - n)) &&
                        (s = !1),
                      s && (I -= n),
                      ...
                      for (d = I * T, i = 0; i < y.length; i++)
                        (p = P[i]),
                          (p.indexLabelTextBlock.x =
                            w.x + d * Math.cos(p.midAngle)),
                          (p.indexLabelTextBlock.y =
                            w.y + d * Math.sin(p.midAngle)),
                      ...
                      for (i = 0; i < y.length; i++)
                        if (
                          ...
                          for (C = 0, _ = 0, A = 0; A < y.length; A++)
                            A !== i &&
                              P[A].hemisphere === p.hemisphere &&
                              (P[A].indexLabelTextBlock.y <
                              p.indexLabelTextBlock.y
                                ? C++
                                : _++);
                          (L = b / (C + _ || 1) * _),
                            ...
                            "right" === p.hemisphere
                              ? ((D = c(i, L)),
                                (z = -1 * (b - D)),
                                (X = c(v, z)),
                                +X.toFixed(k) < +z.toFixed(k) &&
                                  +D.toFixed(k) <= +L.toFixed(k) &&
                                  c(i, -(z - X)))
                              : ((D = c(v, L)),
                                (z = -1 * (b - D)),
                                (X = c(i, z)),
                      ...
                      for (i = 0; i < y.length; i++)
                        (p = P[i]),
                          (d = "pie" === g.type ? 0.7 * I : 0.8 * I),
                          (Y = w.x + d * Math.cos(p.midAngle)),
                          (O = w.y + d * Math.sin(p.midAngle)),
                          (p.indexLabelTextBlock.x = Y),
                          (p.indexLabelTextBlock.y = O);
                    for (i = 0; i < y.length; i++)
                      (p = P[i]),
                        (E = p.indexLabelTextBlock.measureText()),
                        0 !== E.height &&
                          0 !== E.width &&
                          ((W = 0),
                          (R = 0),
                          ...
                          W > 0 &&
                            (!s &&
                              ...
                              ((H =
                                "right" === p.hemisphere
                                  ? M.x2 - p.indexLabelTextBlock.x
                                  : p.indexLabelTextBlock.x - M.x1),
                              0.3 * p.indexLabelTextBlock.maxWidth > H
                                ? (p.indexLabelText = "")
                                : (p.indexLabelTextBlock.maxWidth = 0.85 * H),
                              0.3 * p.indexLabelTextBlock.maxWidth < H &&
                                (p.indexLabelTextBlock.x -=
                                  "right" === p.hemisphere ? 2 : -2)),
                            (Math.abs(
                              p.indexLabelTextBlock.y -
                              ...
                              ((R = W / Math.abs(Math.cos(p.indexLabelAngle))),
                              R > 9 && (R = 0.3 * R),
                              R > n && (n = R))),
                          (V = 0),
                          (j = 0),
                          p.indexLabelAngle > 0 && p.indexLabelAngle < Math.PI
                            ? ((V =
                                M.y2 -
                                (p.indexLabelTextBlock.y +
                                  p.indexLabelTextBlock.height / 2 +
                          ...
                          V > 0 &&
                            (!s &&
                              ...
                              ((U =
                                p.indexLabelAngle > 0 &&
                                p.indexLabelAngle < Math.PI
                                  ? -1
                                  : 1),
                              0 === c(i, V * U) && c(i, 2 * U)),
                            Math.abs(p.indexLabelTextBlock.x - w.x) < I &&
                              ((j = V / Math.abs(Math.sin(p.indexLabelAngle))),
                              j > 9 && (j = 0.3 * j),
                              j > n && (n = j))));
                    t();
                  };
                for (a = 0; 10 > a && (1 > a || n > 0); a++) {
                  var d,
                    p,
                    x,
                    m,
              ...
              function x() {
                if (
                  (u.plotArea.layoutManager.reset(),
                  u._title &&
                    (u._title.dockInsidePlotArea ||
                      ("center" === u._title.horizontalAlign &&
                        "center" === u._title.verticalAlign)) &&
                    u._title.render(),
                  u.subtitles)
                )
                ...
                u.legend &&
                  (u.legend.dockInsidePlotArea ||
                    ("center" === u.legend.horizontalAlign &&
                      "center" === u.legend.verticalAlign)) &&
                  u.legend.render();
              }
              var u = this,
                m = e.dataSeriesIndexes.length;
              if (!(0 >= m)) {
                for (
                  var v = e.dataSeriesIndexes[0],
                    g = this.data[v],
                    y = g.dataPoints,
                    f = 10,
                    b = 500,
                  ...
                  (_ += Math.abs(y[L].y)),
                    !A &&
                      "undefined" != typeof y[L].indexLabel &&
                      null !== y[L].indexLabel &&
                      y[L].indexLabel.toString().length > 0 &&
                      (A = !0),
                    !A &&
                      "undefined" != typeof y[L].label &&
                      null !== y[L].label &&
                      y[L].label.toString().length > 0 &&
                      (A = !0);
                if (0 !== _) {
                  A =
                    A ||
                    ("undefined" != typeof g.indexLabel &&
                      null !== g.indexLabel &&
                      g.indexLabel.toString().length > 0);
                  var I =
                    "inside" !== g.indexLabelPlacement && A
                      ? 0.75 * Math.min(M.width, M.height) / 2
                      : 0.92 * Math.min(M.width, M.height) / 2;
                  g.radius && (I = (0, r.convertPercentToValue)(g.radius, I));
                  var B =
                      "undefined" != typeof g.innerRadius &&
                      null !== g.innerRadius
                        ? (0, r.convertPercentToValue)(g.innerRadius, I)
                        : 0.7 * I,
                    F = Math.min(B / I, (I - 1) / I);
                  (this.pieDoughnutClickHandler = function(e) {
                    if (!u.isAnimating) {
                      ...
                      i.exploded ? (i.exploded = !1) : (i.exploded = !0),
                        a.dataPoints.length > 1 &&
                          u._animator.animate(0, b, function(e) {
                            n(e), x();
                          });
                    }
                  }),
            ...
            (i["default"] = function(e) {
              function t() {
                if (M) {
                  ...
                  for (var t = h.length - 1; t >= 0; t--)
                    (e = h[t]), i.lineTo(e.x, e.y), s.lineTo(e.x, e.y);
                  if (
                    (i.closePath(),
              ...
              if (!(0 >= n)) {
                var s = this._eventManager.ghostCtx,
                  r = (e.axisX.lineCoordinates, e.axisY.lineCoordinates, []),
                  o = this.plotArea;
                i.save(),
                  a.isCanvasSupported && s.save(),
                  i.beginPath(),
                  ...
                  a.isCanvasSupported &&
                    ...
                    s.clip());
                for (var l = 0; l < e.dataSeriesIndexes.length; l++) {
                  var h = [],
                    d = e.dataSeriesIndexes[l],
                    c = this.data[d],
                    p = c.dataPoints,
                    x = c.id;
                  ...
                  var m,
                    ...
                    f = !0,
                    b = 0,
                    M = ((e.axisY.conversionParameters.reference +
                      e.axisY.conversionParameters.pixelPerUnit *
                        (0 - e.axisY.conversionParameters.minimum) +
                      0.5) <<
                      0,
                    null);
                  if (p.length > 0) {
                    var P = c._colorSet[b % c._colorSet.length];
                    (i.fillStyle = P),
                      (i.strokeStyle = P),
                    ...
                    for (var S = !0; b < p.length; b++)
                      if (
                        ((y = p[b].x.getTime ? p[b].x.getTime() : p[b].x),
                        !(
                          y < e.axisX.dataInfo.viewPortMin ||
                          y > e.axisX.dataInfo.viewPortMax
                        ))
                      )
                        if (
                          null !== p[b].y &&
                          p[b].y.length &&
                          "number" == typeof p[b].y[0] &&
                          "number" == typeof p[b].y[1]
                        ) {
                          (m =
                            (e.axisX.conversionParameters.reference +
                              e.axisX.conversionParameters.pixelPerUnit *
                                (y - e.axisX.conversionParameters.minimum) +
                              0.5) <<
                            0),
                            (v =
                              (e.axisY.conversionParameters.reference +
                            ...
                            f || S
                              ? (i.beginPath(),
                                ...
                                h.push({ x: m, y: g }),
                                a.isCanvasSupported &&
                                  (s.beginPath(), s.moveTo(m, v)),
                                (f = !1),
                                (S = !1))
                              : (i.lineTo(m, v),
                                h.push({ x: m, y: g }),
                                a.isCanvasSupported && s.lineTo(m, v),
                                b % 250 == 0 && t());
                          var T = c.dataPointIds[b];
                          if (
                            ((this._eventManager.objectMap[T] = {
                              id: T,
                              objectType: "dataPoint",
                            ...
                            var C = c.getMarkerProperties(b, m, g, i);
                            r.push(C);
                            var k = intToHexColorString(T);
                            a.isCanvasSupported &&
                              r.push({
                                x: m,
                                y: g,
                              ...
                              (C = c.getMarkerProperties(b, m, v, i)),
                              r.push(C);
                            var k = intToHexColorString(T);
                            a.isCanvasSupported &&
                              r.push({
            ...
            (i["default"] = function(e) {
              ...
              if (!(0 >= i)) {
                var n,
                  ...
                  h = this.plotArea,
                  d = 0,
                  c = ((e.axisY.conversionParameters.reference +
                    e.axisY.conversionParameters.pixelPerUnit *
                      (0 - e.axisY.conversionParameters.minimum)) <<
                    0,
                  this.dataPointMaxWidth
                ...
                for (var u = 0; u < e.dataSeriesIndexes.length; u++) {
                  var m = e.dataSeriesIndexes[u],
                    ...
                    g = v.dataPoints;
                  if (g.length > 0) {
                    var y = x > 5 && v.bevelEnabled ? !0 : !1;
                    for (t.strokeStyle = "#4572A7 ", d = 0; d < g.length; d++)
                      if (
                        ...
                        !(
                          ...
                          null !== g[d].y &&
                          g[d].y.length &&
                          "number" == typeof g[d].y[0] &&
                          "number" == typeof g[d].y[1])
                      ) {
                        (n =
                          (e.axisY.conversionParameters.reference +
                            e.axisY.conversionParameters.pixelPerUnit *
                        ...
                        (l = g[d].color
                          ? g[d].color
                          : v._colorSet[d % v._colorSet.length]),
                          drawRect(
                            t,
                            n,
                            f,
                        ...
                        (this._eventManager.objectMap[P] = {
                          ...
                          (g[d].indexLabel ||
                            ...
                            (this._indexLabels.push({
                              ...
                              indexKeyword: 0,
                              point: {
                                x: g[d].y[1] >= g[d].y[0] ? n : s,
                                y: f + (b - f) / 2
                              },
                              direction: g[d].y[1] >= g[d].y[0] ? -1 : 1,
                              bounds: {
                                x1: Math.min(n, s),
                                y1: f,
                                x2: Math.max(n, s),
              ...
              function t() {
                ...
                if (e.length > 0) {
                  ...
                  d.lineThickness > 0 && i.stroke(),
                    (e = getBezierPoints(b, 2)),
                    i.lineTo(b[b.length - 1].x, b[b.length - 1].y);
                  ...
                  if (
                    ...
                    i.beginPath(),
                      i.moveTo(b[b.length - 1].x, b[b.length - 1].y);
                    for (var t = e.length - 1; t > 2; t -= 3)
                      i.bezierCurveTo(
                        e[t - 1].x,
                        e[t - 1].y,
                  ...
                  i.beginPath(),
                    a.isCanvasSupported && (s.closePath(), s.fill());
                }
              }
              var i = e.targetCanvasCtx || this.plotArea.ctx,
                n = e.dataSeriesIndexes.length;
              if (!(0 >= n)) {
                ...
                for (var l = 0; l < e.dataSeriesIndexes.length; l++) {
                  ...
                  var u,
                    ...
                    g,
                    y = 0,
                    f = ((e.axisY.conversionParameters.reference +
                      e.axisY.conversionParameters.pixelPerUnit *
                        (0 - e.axisY.conversionParameters.minimum) +
                      0.5) <<
                      0,
                  ...
                  if (c.length > 0) {
                    for (
                      color = d._colorSet[y % d._colorSet.length],
                        i.fillStyle = color,
                        i.strokeStyle = color,
                      ...
                      if (
                        ((g = c[y].x.getTime ? c[y].x.getTime() : c[y].x),
                        !(
                          g < e.axisX.dataInfo.viewPortMin ||
                        ...
                        if (
                          null !== c[y].y &&
                          c[y].y.length &&
                          "number" == typeof c[y].y[0] &&
                          "number" == typeof c[y].y[1]
                        ) {
                          (u =
                            (e.axisX.conversionParameters.reference +
                              e.axisX.conversionParameters.pixelPerUnit *
                          ...
                          if (
                            ...
                            (b[b.length] = { x: u, y: v }),
                            0 !== c[y].markerSize &&
                              (c[y].markerSize > 0 || d.markerSize > 0))
                          ) {
                            var P = d.getMarkerProperties(y, u, m, i);
                            r.push(P);
                            var S = intToHexColorString(M);
                            a.isCanvasSupported &&
                              r.push({
                                x: u,
                                y: m,
                            ...
                            var P = d.getMarkerProperties(y, u, v, i);
                            r.push(P);
                            var S = intToHexColorString(M);
                            a.isCanvasSupported &&
                              r.push({
              ...
              if (!(0 >= i)) {
                ...
                for (var m = 0; m < e.dataSeriesIndexes.length; m++) {
                  ...
                  if (
                    ...
                    for (
                      var f = (Math.pow(
                          0.3 * Math.min(d.height, d.width) / 2,
                          2
                        ) * Math.PI,
                        0),
                        b = 0,
                      ...
                      if (
                        ((r = r = y[c].getTime ? y[c].x.getTime() : y[c].x),
                        !(
                          r < e.axisX.dataInfo.viewPortMin ||
                          r > e.axisX.dataInfo.viewPortMax
                        ) && "number" == typeof y[c].y)
                        ...
                        (a =
                          ...
                          (n =
                            (e.axisY.conversionParameters.reference +
                              ...
                              0.5) <<
                            0);
                        var M = g.getMarkerProperties(c, a, n, t);
                        if (
                          ((t.globalAlpha = g.fillOpacity),
                          s["default"].drawMarker(
                            M.x,
                            M.y,
                            M.ctx,
                          ...
                          var S = (0, l.intToHexColorString)(P);
                          l.isCanvasSupported &&
                            s["default"].drawMarker(
                              M.x,
                              M.y,
          ...
          Object.defineProperty(i, "__esModule", { value: !0 }),
            (i["default"] = function(e) {
                  ...
                  for (var n = 0; n < t.length - 3; n += 3)
                    i.bezierCurveTo(
                      ...
                      n > 0 &&
                        ...
                        (i.stroke(),
                        i.beginPath(),
                        i.moveTo(t[n + 3].x, t[n + 3].y),
                        a.isCanvasSupported &&
                          (s.stroke(),
                          s.beginPath(),
                          s.moveTo(t[n + 3].x, t[n + 3].y)));
                  i.stroke(), a.isCanvasSupported && s.stroke();
                }
              }
              var i = e.targetCanvasCtx || this.plotArea.ctx,
                n = e.dataSeriesIndexes.length;
              if (!(0 >= n)) {
                ...
                i.save();
                var r = this.plotArea;
                i.beginPath(), i.rect(r.x1, r.y1, r.width, r.height), i.clip();
                for (var o = [], l = 0; l < e.dataSeriesIndexes.length; l++) {
                  var h = e.dataSeriesIndexes[l],
                    d = this.data[h];
                  i.lineWidth = d.lineThickness;
                  var c = d.dataPoints;
                  ...
                  (s.strokeStyle = x),
                    (s.lineWidth =
                      d.lineThickness > 0 ? Math.max(d.lineThickness, 4) : 0);
                  var u = d._colorSet,
                    m = u[0];
                  i.strokeStyle = m;
                  var v,
                    ...
                    f = 0,
                    b = [];
                  if ((i.beginPath(), c.length > 0))
                    for (f = 0; f < c.length; f++)
                      if (
                        ((y = c[f].getTime ? c[f].x.getTime() : c[f].x),
                        !(
                          y < e.axisX.dataInfo.viewPortMin ||
                          y > e.axisX.dataInfo.viewPortMax
                        ))
                      )
                        if ("number" == typeof c[f].y) {
                          (v =
                            (e.axisX.conversionParameters.reference +
                              e.axisX.conversionParameters.pixelPerUnit *
                                (y - e.axisX.conversionParameters.minimum) +
                          ...
                          if (
                            ...
                            var P = d.getMarkerProperties(f, v, g, i);
                            o.push(P);
                            var S = intToHexColorString(M);
                            a.isCanvasSupported &&
                              o.push({
            ...
            (i["default"] = function(e) {
              function t() {
                ...
                if (t.length > 0) {
                  ...
                  p.lineThickness > 0 && i.stroke(),
                    e.axisY.viewportMinimum <= 0 && e.axisY.viewportMaximum >= 0
                      ? (f = M)
                      : e.axisY.viewportMaximum < 0
                        ? (f = o.y1)
                        : e.axisY.viewportMinimum > 0 && (f = r.y2),
                    (P = { x: t[0].x, y: t[0].y }),
                    i.lineTo(t[t.length - 1].x, f),
                    i.lineTo(P.x, f),
                    i.closePath(),
                    (i.globalAlpha = p.fillOpacity),
                    i.fill(),
                    (i.globalAlpha = 1),
                    a.isCanvasSupported &&
                      (s.lineTo(t[t.length - 1].x, f),
                      s.lineTo(P.x, f),
                      s.closePath(),
                      s.fill());
                }
              ...
              if (!(0 >= n)) {
                ...
                i.save(),
                  ...
                  a.isCanvasSupported &&
                    (s.beginPath(),
                    s.rect(h.x1, h.y1, h.width, h.height),
                    s.clip());
                for (var d = 0; d < e.dataSeriesIndexes.length; d++) {
                  var c = e.dataSeriesIndexes[d],
                    p = this.data[c],
                    x = p.dataPoints,
                    u = p.id;
                  ...
                  if (x.length > 0) {
                    for (
                      color = p._colorSet[b % p._colorSet.length],
                        i.fillStyle = color,
                        i.strokeStyle = color,
                        i.lineWidth = p.lineThickness,
                        i.setLineDash &&
                          i.setLineDash(
                            getLineDashArray(p.lineDashType, p.lineThickness)
                          );
                      b < x.length;
                      b++
                    )
                      if (
                        ((y = x[b].x.getTime ? x[b].x.getTime() : x[b].x),
                        !(
                          y < e.axisX.dataInfo.viewPortMin ||
                          y > e.axisX.dataInfo.viewPortMax
                        ))
                      )
                        if ("number" == typeof x[b].y) {
                          (v =
                            (e.axisX.conversionParameters.reference +
                              e.axisX.conversionParameters.pixelPerUnit *
                                (y - e.axisX.conversionParameters.minimum) +
                          ...
                          if (
                            ...
                            (S[S.length] = { x: v, y: g }),
                            0 !== x[b].markerSize &&
                              (x[b].markerSize > 0 || p.markerSize > 0))
                          ) {
                            var C = p.getMarkerProperties(b, v, g, i);
                            l.push(C);
                            var k = intToHexColorString(T);
                            a.isCanvasSupported &&
                              l.push({
                          ...
                          (x[b].indexLabel ||
                            ...
                            this._indexLabels.push({
                              ...
                              dataSeries: p,
                              point: { x: v, y: g },
                              direction: x[b].y >= 0 ? 1 : -1,
                              color: color
                            });
                        } else b > 0 && (t(), (S = []));
                    t(), RenderHelper.drawMarkers(l);
                  }
                }
                i.restore(),
                  a.isCanvasSupported && this._eventManager.ghostCtx.restore();
                  ...
                  m =
                    (e.axisY.conversionParameters.reference +
                      e.axisY.conversionParameters.pixelPerUnit *
                        (0 - e.axisY.conversionParameters.minimum)) <<
                    0,
                  v = (e.axisX.dataInfo.minDiff, this._eventManager.ghostCtx);
                l.isCanvasSupported && v.beginPath(),
                  t.save(),
                  l.isCanvasSupported && v.save(),
                  t.beginPath(),
                  t.rect(c.x1, c.y1, c.width, c.height),
                  t.clip(),
                  l.isCanvasSupported &&
                    (v.beginPath(),
                    v.rect(c.x1, c.y1, c.width, c.height),
                    v.clip());
                for (var g = [], y = 0; y < e.dataSeriesIndexes.length; y++) {
                  var f,
                    b = e.dataSeriesIndexes[y],
                    M = this.data[b],
                    P = M.dataPoints;
                  for (M.dataPointIndexes = [], u = 0; u < P.length; u++)
                    (f = P[u].x.getTime ? P[u].x.getTime() : P[u].x),
                      (M.dataPointIndexes[f] = u),
                      g[f] || (x.push(f), (g[f] = !0));
                  x.sort(l.compareNumbers);
                }
                for (var y = 0; y < e.dataSeriesIndexes.length; y++) {
                  var b = e.dataSeriesIndexes[y],
                    M = this.data[b],
                    P = M.dataPoints,
                    S = !0,
                    T = [],
                  ...
                  var k = (0, l.intToHexColorString)(C);
                  if (((v.fillStyle = k), x.length > 0)) {
                    for (
                      h = M._colorSet[0],
                        t.fillStyle = h,
                        t.strokeStyle = h,
                        t.lineWidth = M.lineThickness,
                        t.setLineDash &&
                          t.setLineDash(
                            (0, l.getLineDashArray)(
                              M.lineDashType,
                      ...
                      if (
                        ((w =
                          M.dataPointIndexes[r] >= 0
                            ? P[M.dataPointIndexes[r]]
                            : { x: r, y: 0 }),
                        !(
                          r < e.axisX.dataInfo.viewPortMin ||
                          r > e.axisX.dataInfo.viewPortMax
                        ...
                        var a =
                          ...
                          n =
                            e.axisY.conversionParameters.reference +
                            e.axisY.conversionParameters.pixelPerUnit *
                              (w.y - e.axisY.conversionParameters.minimum),
                          _ = p[r] ? p[r] : 0;
                        if (
                          ((n -= _),
                          T.push({ x: a, y: m - _ }),
                          ...
                          t.beginPath(),
                            t.moveTo(a, n),
                            l.isCanvasSupported &&
                              (v.beginPath(), v.moveTo(a, n)),
                            (S = !1);
                        else if (
                          (t.lineTo(a, n),
                          l.isCanvasSupported && v.lineTo(a, n),
                          u % 250 == 0)
                        ) {
                          for (
                            M.lineThickness > 0 && t.stroke();
                            T.length > 0;

                          ) {
                            var A = T.pop();
                            t.lineTo(A.x, A.y),
                              l.isCanvasSupported && v.lineTo(A.x, A.y);
                          }
                          t.closePath(),
                            (t.globalAlpha = M.fillOpacity),
                            t.fill(),
                            (t.globalAlpha = 1),
                            t.beginPath(),
                            t.moveTo(a, n),
                        ...
                        if (M.dataPointIndexes[r] >= 0) {
                          var L = M.dataPointIds[M.dataPointIndexes[r]];
                          this._eventManager.objectMap[L] = {
                            id: L,
                            objectType: "dataPoint",
                            dataSeriesIndex: b,
                            dataPointIndex: M.dataPointIndexes[r],
                            x1: a,
                            y1: n
                          };
                        }
                        if (
                          M.dataPointIndexes[r] >= 0 &&
                          0 !== w.markerSize &&
                          (w.markerSize > 0 || M.markerSize > 0)
                        ) {
                          var I = M.getMarkerProperties(u, a, n, t);
                          d.push(I),
                            (markerColor = (0, l.intToHexColorString)(L)),
                            l.isCanvasSupported &&
                              d.push({
                                x: a,
                                y: n,
                        ...
                        (w.indexLabel ||
                          ...
                          this._indexLabels.push({
                            ...
                            dataSeries: M,
                            point: { x: a, y: n },
                            direction: P[u].y >= 0 ? 1 : -1,
                            color: h
                          });
                      }
                    }
                    for (M.lineThickness > 0 && t.stroke(); T.length > 0; ) {
                      var A = T.pop();
                      t.lineTo(A.x, A.y),
                        l.isCanvasSupported && v.lineTo(A.x, A.y);
                    }
                  ...
                  delete M.dataPointIndexes;
                }
                s["default"].drawMarkers(d),
                  t.restore(),
                  l.isCanvasSupported && v.restore();
                var B = {
                  source: t,
                  dest: this.plotArea.ctx,
                  animationCallback: o["default"].xClipAnimation,
          ...
          Object.defineProperty(i, "__esModule", { value: !0 }),
            (i["default"] = function(e) {
              ...
              if (!(0 >= i)) {
                  ...
                  m =
                    (e.axisY.conversionParameters.reference +
                      e.axisY.conversionParameters.pixelPerUnit *
                        (0 - e.axisY.conversionParameters.minimum)) <<
                    0,
                  v = this.dataPointMaxWidth
                    ? this.dataPointMaxWidth
                    : (0.15 * this.width) << 0,
                  g = e.axisX.dataInfo.minDiff,
                  y =
                    (d.width /
                      Math.abs(
                        e.axisX.viewportMaximum - e.axisX.viewportMinimum
                ...
                t.save(),
                  l.isCanvasSupported && f.save(),
                  t.beginPath(),
                  t.rect(d.x1, d.y1, d.width, d.height),
                  t.clip(),
                  l.isCanvasSupported &&
                    (f.beginPath(),
                    f.rect(d.x1, d.y1, d.width, d.height),
                    f.clip());
                for (var b = [], M = 0; M < e.dataSeriesIndexes.length; M++) {
                  var P,
                    S = e.dataSeriesIndexes[M],
                    T = this.data[S],
                    C = T.dataPoints;
                  for (T.dataPointIndexes = [], u = 0; u < C.length; u++)
                    (P = C[u].x.getTime ? C[u].x.getTime() : C[u].x),
                      (T.dataPointIndexes[P] = u),
                      b[P] || (x.push(P), (b[P] = !0));
                  x.sort(l.compareNumbers);
                }
                for (var M = 0; M < e.dataSeriesIndexes.length; M++) {
                  var S = e.dataSeriesIndexes[M],
                    T = this.data[S],
                    C = T.dataPoints,
                    k = !0,
                    w = T.id;
                  ...
                  var A = [];
                  if (x.length > 0) {
                    (h = T._colorSet[u % T._colorSet.length]),
                      (t.fillStyle = h),
                      (t.strokeStyle = h),
                      (t.lineWidth = T.lineThickness),
                      t.setLineDash &&
                        t.setLineDash(
                          (0, l.getLineDashArray)(
                            T.lineDashType,
                    ...
                    for (u = 0; u < x.length; u++) {
                      ...
                      if (
                        ((L =
                          T.dataPointIndexes[r] >= 0
                            ? C[T.dataPointIndexes[r]]
                            : { x: r, y: 0 }),
                        !(
                          r < e.axisX.dataInfo.viewPortMin ||
                          r > e.axisX.dataInfo.viewPortMax
                        ...
                        var I;
                        I =
                          0 !== e.dataPointYSums[r]
                            ? L.y / e.dataPointYSums[r] * 100
                            : 0;
                        var a =
                            (e.axisX.conversionParameters.reference +
                              e.axisX.conversionParameters.pixelPerUnit *
                          ...
                          n =
                            e.axisY.conversionParameters.reference +
                            e.axisY.conversionParameters.pixelPerUnit *
                              (I - e.axisY.conversionParameters.minimum),
                          B = p[r] ? p[r] : 0;
                        if (
                          ((n -= B),
                          A.push({ x: a, y: m - B }),
                          ...
                          t.beginPath(),
                            t.moveTo(a, n),
                            l.isCanvasSupported &&
                              (f.beginPath(), f.moveTo(a, n)),
                            (k = !1);
                        else if (
                          (t.lineTo(a, n),
                          l.isCanvasSupported && f.lineTo(a, n),
                          u % 250 == 0)
                        ) {
                          for (
                            T.lineThickness > 0 && t.stroke();
                            A.length > 0;

                          ) {
                            var F = A.pop();
                            t.lineTo(F.x, F.y),
                              l.isCanvasSupported && f.lineTo(F.x, F.y);
                          }
                          t.closePath(),
                            (t.globalAlpha = T.fillOpacity),
                            t.fill(),
                            (t.globalAlpha = 1),
                            t.beginPath(),
                            t.moveTo(a, n),
                        ...
                        if (T.dataPointIndexes[r] >= 0) {
                          var z = T.dataPointIds[T.dataPointIndexes[r]];
                          this._eventManager.objectMap[z] = {
                            id: z,
                            objectType: "dataPoint",
                            dataSeriesIndex: S,
                            dataPointIndex: T.dataPointIndexes[r],
                            x1: a,
                            y1: n
                          };
                        }
                        if (
                          T.dataPointIndexes[r] >= 0 &&
                          0 !== L.markerSize &&
                          (L.markerSize > 0 || T.markerSize > 0)
                        ) {
                          var D = T.getMarkerProperties(u, a, n, t);
                          c.push(D),
                            (markerColor = (0, l.intToHexColorString)(z)),
                            l.isCanvasSupported &&
                              c.push({
                                x: a,
                                y: n,
                        ...
                        (L.indexLabel ||
                          ...
                          this._indexLabels.push({
                            ...
                            dataSeries: T,
                            point: { x: a, y: n },
                            direction: C[u].y >= 0 ? 1 : -1,
                            color: h
                          });
                      }
                    }
                    for (T.lineThickness > 0 && t.stroke(); A.length > 0; ) {
                      var F = A.pop();
                      t.lineTo(F.x, F.y),
                        l.isCanvasSupported && f.lineTo(F.x, F.y);
                    }
                ...
                s["default"].drawMarkers(c),
                  t.restore(),
                  l.isCanvasSupported && f.restore();
                var X = {
                  source: t,
                  dest: this.plotArea.ctx,
                  animationCallback: o["default"].xClipAnimation,
              ...
              if (!(0 >= i)) {
                ...
                for (var v = 0; v < e.dataSeriesIndexes.length; v++) {
                  var g = e.dataSeriesIndexes[v],
                    ...
                    f = y.dataPoints;
                  if (f.length > 0) {
                    var b = m > 5 && y.bevelEnabled ? !0 : !1;
                    for (t.strokeStyle = "#4572A7 ", c = 0; c < f.length; c++)
                      if (
                        ((r = f[c].x.getTime ? f[c].x.getTime() : f[c].x),
                        !(
                          r < e.axisX.dataInfo.viewPortMin ||
                          r > e.axisX.dataInfo.viewPortMax
                        ) && "number" == typeof f[c].y)
                        ...
                        (s =
                          ...
                          (n =
                            e.axisY.conversionParameters.reference +
                            e.axisY.conversionParameters.pixelPerUnit *
                              (f[c].y - e.axisY.conversionParameters.minimum));
                        var M,
                          P,
                          S =
                            (s -
                              e.plotType.plotUnits.length * m / 2 +
                              e.index * m) <<
                            0,
                          T = (S + m) << 0;
                        if (f[c].y >= 0) {
                          var C = h[r] ? h[r] : 0;
                          (M = p + C), (P = n + C), (h[r] = C + (P - M));
                        } else {
                          var C = d[r] ? d[r] : 0;
                          (M = n - C), (P = p - C), (d[r] = C + (P - M));
                        }
                        (o = f[c].color
                          ? f[c].color
                          : y._colorSet[c % y._colorSet.length]),
                          drawRect(
                            t,
                            M,
                            S,
                        ...
                        (this._eventManager.objectMap[k] = {
                          ...
                          (f[c].indexLabel ||
                            y.indexLabel ||
                            f[c].indexLabelFormatter ||
                            y.indexLabelFormatter) &&
                            this._indexLabels.push({
                              chartType: "stackedBar",
                              dataPoint: f[c],
                              dataSeries: y,
                              point: { x: f[c].y >= 0 ? P : M, y: s },
                              direction: f[c].y >= 0 ? 1 : -1,
                              bounds: {
                                x1: Math.min(M, P),
                                y1: S,
                                x2: Math.max(M, P),
                ...
                t.restore(),
                  a.isCanvasSupported && this._eventManager.ghostCtx.restore();
                var w = Math.max(p, e.axisX.boundingRect.x2),
                  _ = {
                    source: t,
                    dest: this.plotArea.ctx,
          ...
          Object.defineProperty(i, "__esModule", { value: !0 }),
            (i["default"] = function(e) {
              ...
              if (!(0 >= i)) {
                  ...
                  if (f.length > 0) {
                    ...
                    for (t.strokeStyle = "#4572A7 ", c = 0; c < f.length; c++)
                      if (
                        ...
                        (M =
                          0 !== e.dataPointYSums[r]
                            ? f[c].y / e.dataPointYSums[r] * 100
                            : 0),
                          (n =
                            e.axisY.conversionParameters.reference +
                            e.axisY.conversionParameters.pixelPerUnit *
                              (M - e.axisY.conversionParameters.minimum));
                        var P,
                          S,
                          T =
                            (s -
                        ...
                        if (f[c].y >= 0) {
                          var k = h[r] ? h[r] : 0;
                          (P = p + k), (S = n + k), (h[r] = k + (S - P));
                        } else {
                          var k = d[r] ? d[r] : 0;
                          (P = n - k), (S = p - k), (d[r] = k + (S - P));
                        }
                        (o = f[c].color
                          ? f[c].color
                          : y._colorSet[c % y._colorSet.length]),
                ...
                t.restore(),
                  a.isCanvasSupported && this._eventManager.ghostCtx.restore();
                var _ = Math.max(p, e.axisX.boundingRect.x2),
                  A = {
                    source: t,
                    dest: this.plotArea.ctx,
                    animationCallback: AnimationHelper.xScaleAnimation,
          ...
          Object.defineProperty(i, "__esModule", { value: !0 }),
            (i["default"] = function(e) {
              ...
              if (!(0 >= i)) {
                  ...
                  if (f.length > 0) {
                    ...
                    for (t.strokeStyle = "#4572A7 ", c = 0; c < f.length; c++)
                      if (
                        ...
                        if (f[c].y >= 0) {
                          var C = h[r] ? h[r] : 0;
                          (M = s - C), (P = p - C), (h[r] = C + (P - M));
                        } else {
                          var C = d[r] ? d[r] : 0;
                          (P = s + C), (M = p + C), (d[r] = C + (P - M));
                        }
                        (o = f[c].color
                          ? f[c].color
                          : y._colorSet[c % y._colorSet.length]),
                ...
                t.restore(),
                  a.isCanvasSupported && this._eventManager.ghostCtx.restore();
                var w = Math.min(p, e.axisY.boundingRect.y2),
                  _ = {
                    source: t,
                    dest: this.plotArea.ctx,
          ...
          Object.defineProperty(i, "__esModule", { value: !0 }),
            (i["default"] = function(e) {
              ...
              if (!(0 >= i)) {
                  ...
                  if (f.length > 0) {
                    ...
                    for (c = 0; c < f.length; c++)
                      if (
                        ...
                        if (f[c].y >= 0) {
                          var k = h[r] ? h[r] : 0;
                          (P = s - k), (S = p - k), (h[r] = k + (S - P));
                        } else {
                          var k = d[r] ? d[r] : 0;
                          (S = s + k), (P = p + k), (d[r] = k + (S - P));
                        }
                        (o = f[c].color
                          ? f[c].color
                          : y._colorSet[c % y._colorSet.length]),
                ...
                t.restore(),
                  a.isCanvasSupported && this._eventManager.ghostCtx.restore();
                var _ = Math.min(p, e.axisY.boundingRect.y2),
                  A = {
                    source: t,
                    dest: this.plotArea.ctx,
                    animationCallback: AnimationHelper.yScaleAnimation,
            ...
            (i["default"] = function(e) {
              function t() {
                S &&
                  ...
                  (i.globalAlpha = 1),
                  a.isCanvasSupported &&
                    (s.lineTo(v, f), s.lineTo(S.x, f), s.closePath(), s.fill()),
                  i.beginPath(),
                  i.moveTo(v, g),
                  s.beginPath(),
                  s.moveTo(v, g),
              ...
              if (!(0 >= n)) {
                ...
                for (var d = 0; d < e.dataSeriesIndexes.length; d++) {
                  ...
                  var v,
                    ...
                    T = !1;
                  if (x.length > 0) {
                    var C = p._colorSet[M % p._colorSet.length];
                    for (
                      i.fillStyle = C,
                        i.strokeStyle = C,
                        i.lineWidth = p.lineThickness,
                      ...
                      if (
                        ((y = x[M].x.getTime ? x[M].x.getTime() : x[M].x),
                        !(
                          y < e.axisX.dataInfo.viewPortMin ||
                          y > e.axisX.dataInfo.viewPortMax
                        ))
                          ...
                          (v =
                            ...
                            b || T
                              ? (i.beginPath(),
                                ...
                                (S = { x: v, y: g }),
                                a.isCanvasSupported &&
                                  (s.beginPath(), s.moveTo(v, g)),
                                (b = !1),
                                (T = !1))
                              : (i.lineTo(v, k),
                                a.isCanvasSupported && s.lineTo(v, k),
                                i.lineTo(v, g),
                                a.isCanvasSupported && s.lineTo(v, g),
                                M % 250 == 0 && t());
                          var w = p.dataPointIds[M];
                          if (
                            ((this._eventManager.objectMap[w] = {
                              id: w,
                              objectType: "dataPoint",
                            ...
                            0 !== x[M].markerSize &&
                              (x[M].markerSize > 0 || p.markerSize > 0))
                          ) {
                            var _ = p.getMarkerProperties(M, v, g, i);
                            l.push(_);
                            var A = intToHexColorString(w);
                            a.isCanvasSupported &&
                              l.push({
                                x: v,
                                y: g,
      ...
      23: [
        function(e, t, i) {
          ...
          Object.defineProperty(i, "__esModule", { value: !0 });
          (i.isDebugMode = !1),
            (i.isCanvasSupported = !!document.createElement("canvas")
              .getContext),
            (i.defaultOptions = {
              Chart: {
                width: 500,
      ...
      25: [
        function(e, t, i) {
          ...
          var s = e("../helpers/animator"),
            r = a(s);
          (n.prototype.animate = function(e, t, i, a, n) {
            var s = this;
            (this.chart.isAnimating = !0),
              (n = n || r["default"].easing.linear),
              i &&
                this.animations.push({
                  startTime: new Date().getTime() + (e ? e : 0),
                  duration: t,
                  animationCallback: i,
                  onComplete: a
                });
            ...
            (n.prototype.cancelAllAnimations = function() {
              (this.animations = []),
        ...
        function(e, t, i) {
          ...
          function n(e, t, i, a) {
            if (
              ...
              "undefined" == typeof this._options.titleFontSize &&
              ...
              (this.type = i),
              "axisX" !== i ||
                (t && "undefined" != typeof t.gridThickness) ||
          ...
          (0, h.extend)(n, r["default"]),
                  ...
                  ? ((s =
                    ...
                    (a = this.labelAutoFit
                      ...
                      : "undefined" == typeof this._options.labelMaxWidth
                        ...
                        : this.labelMaxWidth),
                    (n =
                      "undefined" == typeof this._options.labelWrap ||
                      this.labelWrap
            ...
            (n.setLayoutAndRender = function(e, t, i, a, n) {
              ...
              var c = (t && t.lineThickness ? t.lineThickness : 0,
              i && i.lineThickness ? i.lineThickness : 0,
              t && t.gridThickness ? t.gridThickness : 0,
              i && i.gridThickness ? i.gridThickness : 0,
              t ? t.margin : 0);
              t ? t.margin : 0;
              if ("normal" === a) {
                e.lineCoordinates = {};
                ...
                if (
                  ...
                  for (
                    ...
                    if (
                      ...
                      var a =
                        t.lineWidth % 2 === 1 ? (e.x << 0) + 0.5 : e.x << 0;
                      t.moveTo(a, i.y1 << 0),
                        t.lineTo(a, i.y2 << 0),
                        t.stroke();
                    }
                  ...
                  for (
                    ...
                    if (
                      ...
                      var s =
                        t.lineWidth % 2 === 1 ? (e.y << 0) + 0.5 : e.y << 0;
                      t.moveTo(i.x1 << 0, s),
                        t.lineTo(i.x2 << 0, s),
                        t.stroke();
                    }
            ...
            (n.prototype.convertPixelToValue = function(e) {
              ...
              return (t =
                ...
                (i - this.conversionParameters.reference) /
            ...
            (n.prototype.calculateAxisParameters = function() {
              ...
              if (
                ...
                if (((isNaN(h) || !isFinite(h)) && (h = 2), h > 2))
                  for (var d = 0; h - 2 > d; d++) this.valueFormatString += "#";
              }
            }),
          ...
          (a.prototype.setOptions = function(e, t) {
            ...
            (a.prototype.isBeingTracked = function(e) {
              return (
                ...
                this._options._oldOptions[e] ? !0 : !1
              );
            }),
            (a.prototype.hasOptionChanged = function(e) {
              if (!this.sessionVariables)
                throw "Session Variable Store not set";
              var t = !(this.sessionVariables[e] === this._options[e]);
              return t;
            }),
      ...
      28: [
        function(e, t, i) {
          ...
          function n(e, t, i) {
            ...
            (s = this._options.width
              ...
              (this._selectedColorSet =
                "undefined" != typeof I.colorSets[this.colorSet]
                  ? I.colorSets[this.colorSet]
                  : I.colorSets.colorSet1),
              ...
              (this.canvas = (0, F.createCanvas)(s, r)),
              (this.canvas.style.position = "absolute"),
              this.canvas.getContext &&
                (this._canvasJSContainer.appendChild(this.canvas),
                (this.ctx = this.canvas.getContext("2d")),
                (this.ctx.textBaseline = "top"),
                (0, F.extendCtx)(this.ctx),
                F.isCanvasSupported
                  ? (this.plotArea.ctx = this.ctx)
                  : ((this.plotArea.canvas = (0, F.createCanvas)(s, r)),
                    ...
                    (this.plotArea.ctx = this.plotArea.canvas.getContext(
                      "2d"
                    ))),
                (this.overlaidCanvas = (0, F.createCanvas)(s, r)),
                ...
                (this._eventManager = new y["default"](this)),
                (0, F.addEvent)(window, "resize", function() {
                ...
                (0, F.addEvent)(this.overlaidCanvas, "click", function(e) {
                  a._mouseEventHandler(e);
                }),
                (0, F.addEvent)(this.overlaidCanvas, "mousemove", function(e) {
                  a._mouseEventHandler(e);
                }),
                (0, F.addEvent)(this.overlaidCanvas, "mouseup", function(e) {
                  a._mouseEventHandler(e);
                }),
                (0, F.addEvent)(this.overlaidCanvas, "mousedown", function(e) {
                  a._mouseEventHandler(e), (0, F.hide)(a._dropdownMenu);
                }),
                (0, F.addEvent)(this.overlaidCanvas, "mouseout", function(e) {
                  a._mouseEventHandler(e);
                }),
                (0, F.addEvent)(
                  this.overlaidCanvas,
          ...
          var s = e("./canvasjs"),
            ...
            w = e("../core/legend"),
            _ = a(w),
            A = e("../helpers/animator"),
            L = a(A),
            I = e("../constants/themes"),
            B = e("../constants/options"),
            F = e("../helpers/utils"),
            z = e("../charts/index");
          (0, F.extend)(n, r["default"]),
            (n.prototype._updateOptions = function() {
              ...
              if (
                ...
                (this._cultureInfo = new P["default"](this._options.culture)),
                this.updateOption("animationEnabled"),
                (this.animationEnabled =
                  this.animationEnabled && F.isCanvasSupported),
                ...
                this._options.zoomEnabled
                  ? (this._zoomButton ||
                      ...
                      (0, F.addEvent)(this._zoomButton, "click", function() {
                        e.zoomEnabled
                          ? ((e.zoomEnabled = !1),
                            (e.panEnabled = !0),
                    ...
                    this._resetButton ||
                      ...
                      (0, F.addEvent)(this._resetButton, "click", function() {
                        e._toolTip.hide(),
                          ...
                          e.sessionVariables.axisX &&
                            ((e.sessionVariables.axisX.newViewportMinimum = null),
                            (e.sessionVariables.axisX.newViewportMaximum = null)),
                          e.sessionVariables.axisY &&
                            ((e.sessionVariables.axisY.newViewportMinimum = null),
                            (e.sessionVariables.axisY.newViewportMaximum = null)),
                          e.sessionVariables.axisY2 &&
                            ((e.sessionVariables.axisY2.newViewportMinimum = null),
                            (e.sessionVariables.axisY2.newViewportMaximum = null)),
                          e.resetOverlayedCanvas(),
                          (0, F.hide)(e._zoomButton, e._resetButton),
                    ...
                    this.zoomEnabled ||
                      ...
                      (this._zoomButton
                        ? (e._zoomButton.getAttribute("state") ===
                          ...
                          (0, F.show)(e._zoomButton, e._resetButton))
                        : ((this.zoomEnabled = !0), (this.panEnabled = !1))))
                  : ((this.zoomEnabled = !1), (this.panEnabled = !1)),
                this._menuButton
                  ? this.exportEnabled
                    ? (0, F.show)(this._menuButton)
                    : (0, F.hide)(this._menuButton)
                  : this.exportEnabled &&
                    F.isCanvasSupported &&
              ...
              if (
                ...
                "undefined" == typeof B.defaultOptions.Chart.creditHref)
              )
                ...
                this._options.height
                  ...
                  : (this.height = t =
                      this._container.clientHeight > 0
                        ? this._container.clientHeight
                        : this.height),
                this.canvas.width !== e * F.devicePixelBackingStoreRatio ||
                this.canvas.height !== t * F.devicePixelBackingStoreRatio
                  ? ((0, F.setCanvasSize)(this.canvas, e, t),
                    (0, F.setCanvasSize)(this.overlaidCanvas, e, t),
                    (0, F.setCanvasSize)(this._eventManager.ghostCanvas, e, t),
                    !0)
                  : !1
              );
            }),
            (n.prototype._initialize = function() {
              this._animator
                ...
                : (this._animator = new l["default"](this)),
                ...
                (this.layoutManager = new v["default"](
                  0,
                  0,
                  this.width,
                  this.height,
              ...
              for (var e = 0, t = 0; t < this._options.data.length; t++)
                if (
                  ...
                  !this._options.data[t].type ||
                    n._supportedChartTypes.indexOf(
                      this._options.data[t].type
                    ) >= 0)
                ) {
                  var i = new d["default"](
                  ...
                  null === i.name && (i.name = "DataSeries " + e),
                    null === i.color
                      ? this._options.data.length > 1
                        ? ((i._colorSet = [
                          ...
                          (i.color = this._selectedColorSet[
                            i.index % this._selectedColorSet.length
                          ]))
                        : "line" === i.type ||
                          "stepLine" === i.type ||
                    ...
                    ("bubble" !== i.type && "scatter" !== i.type) ||
                      !i.dataPoints ||
                      i.dataPoints.sort(F.compareDataPointX),
                    this.data.push(i);
                  var a,
                    s = i.axisPlacement;
                  if (
            ...
            (n._supportedChartTypes = (0, F.addArrayIndexOf)([
              "line",
              "stepLine",
              "spline",
              "column",
            ...
            (n.prototype.render = function(e) {
              ...
              this.axisY &&
                ...
                "undefined" == typeof this.axisY2._options.gridThickness
                  ? (this.axisY2.gridThickness = 0)
                  : this.axisY2.gridThickness > 0 &&
                    "undefined" == typeof this.axisY._options.gridThickness &&
                    (this.axisY.gridThickness = 0));
              var a = !1;
              if (
                this._axes.length > 0 &&
              ...
              if (
                (a
                  ? (0, F.show)(this._zoomButton, this._resetButton)
                  : (0, F.hide)(this._zoomButton, this._resetButton),
                this._processData(),
                this._options.title &&
                  ((this._title = new k["default"](this, this._options.title)),
              ...
              if (this.animatedRender) {
                var o = (0, F.createCanvas)(this.width, this.height),
                  l = o.getContext("2d");
                l.drawImage(this.canvas, 0, 0, this.width, this.height);
              }
              for (var i = 0; i < this.plotInfo.plotTypes.length; i++)
                for (
                  var h = this.plotInfo.plotTypes[i], d = 0;
                  ...
                  (c.targetCanvas = null),
                    this.animatedRender &&
                      ((c.targetCanvas = (0, F.createCanvas)(
                        this.width,
                        this.height
                      )),
                      (c.targetCanvasCtx = c.targetCanvas.getContext("2d"))),
                    "line" === c.type
                      ? (p = this.renderLine(c))
                      : "stepLine" === c.type
                        ? (p = this.renderStepLine(c))
                        : "spline" === c.type
                          ? (p = this.renderSpline(c))
                          : "column" === c.type
                            ? (p = this.renderColumn(c))
                            : "bar" === c.type
                              ? (p = this.renderBar(c))
                              : "area" === c.type
                                ? (p = this.renderArea(c))
                                : "stepArea" === c.type
                                  ? (p = this.renderStepArea(c))
                                  : "splineArea" === c.type
                                    ? (p = this.renderSplineArea(c))
                                    : "stackedColumn" === c.type
                                      ? (p = this.renderStackedColumn(c))
                                      : "stackedColumn100" === c.type
                                        ? (p = this.renderStackedColumn100(c))
                                        : "stackedBar" === c.type
                                          ? (p = this.renderStackedBar(c))
                                          : "stackedBar100" === c.type
                                            ? (p = this.renderStackedBar100(c))
                                            : "stackedArea" === c.type
                                              ? (p = this.renderStackedArea(c))
                                              : "stackedArea100" === c.type
                                                ? (p = this.renderStackedArea100(
                                                    c
                                                  ))
                                                : "bubble" === c.type
                                                  ? (p = p = this.renderBubble(
                                                      c
                                                    ))
                                                  : "scatter" === c.type
                                                    ? (p = this.renderScatter(
                                                        c
                                                      ))
                                                    : "pie" === c.type
                                                      ? this.renderPie(c)
                                                      : "doughnut" === c.type
                                                        ...
                                                        : "candlestick" ===
                                                          ...
                                                          : "ohlc" === c.type
                                                            ...
                                                            : "rangeColumn" ===
                                                              c.type
                                                              ? (p = this.renderRangeColumn(
                                                                  c
                                                                ))
                                                              : "rangeBar" ===
                                                                c.type
                                                                ? (p = this.renderRangeBar(
                                                                    c
                                                                  ))
                                                                : "rangeArea" ===
                                                                  c.type
                                                                  ? (p = this.renderRangeArea(
                                                                      c
                                                                    ))
                                                                  : "rangeSplineArea" ===
                                                                      c.type &&
                                                                    (p = this.renderRangeSplineArea(
                                                                      c
                                                                    ));
                  for (var x = 0; x < c.dataSeriesIndexes.length; x++)
                    this._dataInRenderedOrder.push(
                      this.data[c.dataSeriesIndexes[x]]
                    );
                  this.animatedRender && p && r.push(p);
                }
              if (this.animatedRender && this._indexLabels.length > 0) {
                var u = (0, F.createCanvas)(this.width, this.height),
                  m = u.getContext("2d");
                r.push(this.renderIndexLabels(m));
              }
              var v = this;
              if (
                (r.length > 0
                      ...
                      function(e) {
                        v.ctx.clearRect(0, 0, v.width, v.height),
                          v.ctx.drawImage(
                            ...
                            0,
                            Math.floor(
                              v.width * F.devicePixelBackingStoreRatio
                            ),
                            Math.floor(
                              v.height * F.devicePixelBackingStoreRatio
                            ),
                            0,
                            0,
                            v.width,
                        ...
                        for (var t = 0; t < r.length; t++)
                          (p = r[t]),
                            1 > e && "undefined" != typeof p.startTimePercent
                              ? e >= p.startTimePercent &&
                                p.animationCallback(
                                  p.easingFunction(
                                    e - p.startTimePercent,
                                    0,
                                    1,
                                    1 - p.startTimePercent
                                  ),
                                  p
                                )
                              : p.animationCallback(
                                  p.easingFunction(e, 0, 1, 1),
                                  p
                                );
                        v.dispatchEvent("dataAnimationIterationEnd", {
                          chart: v
                        });
                      },
                      function() {
                        r = [];
                        for (var e = 0; e < v.plotInfo.plotTypes.length; e++)
                          for (
                            var t = v.plotInfo.plotTypes[e], i = 0;
                        ...
                        (o = null), (v.disableToolTip = !1);
                      }
                    ))
                  : (v._indexLabels.length > 0 && v.renderIndexLabels(),
                    v.dispatchEvent("dataAnimationIterationEnd", { chart: v })),
                ...
                setTimeout(function() {
                  ...
                  if (e) {
                    (0, F.setCanvasSize)(e, v.width, v.height);
                    var t = e.getContext("2d");
                    t.drawImage(v._eventManager.ghostCanvas, 0, 0);
                  }
                }, 2e3);
              }
            }),
              ...
              for (var e = "", t = 0; t < this.data.length; t++)
                if (
                  ...
                  e.dataPoints &&
                    ...
                    e.visible &&
                    n._supportedChartTypes.indexOf(e.type) >= 0)
                ) {
                  for (
                    var i = null, a = !1, s = null, r = !1, o = 0;
            ...
            (n.prototype.assignIdToDataPoints = function() {
              for (var e = 0; e < this.data.length; e++) {
                var t = this.data[e];
                if (t.dataPoints)
                  for (var i = t.dataPoints.length, a = 0; i > a; a++)
            ...
            (n.prototype._processMultiseriesPlotUnit = function(e) {
              if (e.dataSeriesIndexes && !(e.dataSeriesIndexes.length < 1))
                for (
                  ...
                  for (
                    ...
                    if (
                      ("undefined" == typeof o.dataPoints[l].x &&
                        (o.dataPoints[l].x = l),
            ...
            (n.prototype._processStackedPlotUnit = function(e) {
              if (e.dataSeriesIndexes && !(e.dataSeriesIndexes.length < 1)) {
                for (
                  var t,
                    i,
                  ...
                  for (
                    ...
                    if (
                      ("undefined" == typeof h.dataPoints[d].x &&
                        (h.dataPoints[d].x = d),
            ...
            (n.prototype._processStacked100PlotUnit = function(e) {
              if (e.dataSeriesIndexes && !(e.dataSeriesIndexes.length < 1)) {
                for (
                  var t,
                    i,
                  ...
                  for (
                    ...
                    if (
                      ("undefined" == typeof d.dataPoints[c].x &&
                        (d.dataPoints[c].x = c),
            ...
            (n.prototype._processMultiYPlotUnit = function(e) {
              if (e.dataSeriesIndexes && !(e.dataSeriesIndexes.length < 1))
                for (
                  var t,
                    i,
            ...
            (n.prototype.getDataPointAtXY = function(e, t, i) {
              i = i || !1;
              for (
            ...
            (n.prototype.getObjectAtXY = function(e, t, i) {
              i = i || !1;
              var a = null,
                n = this.getDataPointAtXY(e, t, i);
              if (n) a = n.dataSeries.dataPointIds[n.dataPointIndex];
              else if (F.isCanvasSupported)
                a = (0, F.getObjectId)(e, t, this._eventManager.ghostCtx);
              else
            ...
            (n.prototype.getAutoFontSize = function(e, t, i) {
            ...
            (n.prototype.clearCanvas = function() {
              this.ctx.clearRect(0, 0, this.width, this.height),
                this.backgroundColor &&
                  ((this.ctx.fillStyle = this.backgroundColor),
                  this.ctx.fillRect(0, 0, this.width, this.height));
            }),
            (n.prototype.attachEvent = function(e) {
              this._events.push(e);
            }),
            (n.prototype._touchEventHandler = function(e) {
              if (e.changedTouches && this.interactivityEnabled) {
                ...
                switch (e.type) {
                  ...
                  case "MSPointerDown":
                    (t = ["mousemove", "mousedown"]),
                      (this._lastTouchData = (0, F.getMouseCoordinates)(a)),
                ...
                if (!(i && i.length > 1)) {
                  (n = (0, F.getMouseCoordinates)(a)), (n.time = new Date());
                  try {
                    var s = n.y - this._lastTouchData.y,
                      r = (n.x - this._lastTouchData.x,
                      n.time - this._lastTouchData.time);
                    if (
                      Math.abs(s) > 15 &&
                      (this._lastTouchData.scroll || 200 > r)
                    ) {
            ...
            (n.prototype._dispatchRangeEvent = function(e, t) {
              var i = {};
              ...
              for (var n = 0; n < a.length; n++)
                i[a[n]] = {
                  viewportMinimum: this[a[n]].sessionVariables
                    .newViewportMinimum,
                  viewportMaximum: this[a[n]].sessionVariables
                    .newViewportMaximum
                };
              this.dispatchEvent(e, i, this._publicChartReference);
            }),
            (n.prototype._mouseEventHandler = function(e) {
              if (this.interactivityEnabled) {
                ...
                if (
                  ...
                  B.isDebugMode &&
                    window.console &&
                    (window.console.log(s + " --> x: " + a.x + "; y:" + a.y),
                    i && window.console.log(e.which),
                    "mouseup" === s && window.console.log("mouseup")),
                  !i)
                ) {
                  if (n.capturedEventParam)
                    (t = n.capturedEventParam),
                      ...
                      t.hasOwnProperty(s) && t[s].call(t.context, a.x, a.y);
                  else if (this._events) {
                    for (var r = 0; r < this._events.length; r++)
                      if (this._events[r].hasOwnProperty(s)) {
                        t = this._events[r];
                        var o = t.bounds;
                        if (
                          a.x >= o.x1 &&
                          ...
                          t[s].call(t.context, a.x, a.y),
                            "mousedown" === s && t.capture === !0
                              ? ((n.capturedEventParam = t),
            ...
            (n.prototype._plotAreaMouseDown = function(e, t) {
              (this.isDrag = !0),
                "none" !== this.plotInfo.axisPlacement
                  ? (this.dragStartPoint = { x: e, y: t })
                  : (this.dragStartPoint = { x: e, y: t });
            }),
            (n.prototype._plotAreaMouseUp = function(e, t) {
              if (
                ("normal" === this.plotInfo.axisPlacement ||
                  "xySwapped" === this.plotInfo.axisPlacement) &&
                this.isDrag
            ...
            (n.prototype._plotAreaMouseMove = function(e, t) {
            ...
            (n.prototype._zoomPanToSelectedRegion = function(e, t, i, a, n) {
              n = n || !1;
            ...
            (n.prototype.preparePlotArea = function() {
              ...
              F.isCanvasSupported ||
                ...
                (e.layoutManager = new v["default"](e.x1, e.y1, e.x2, e.y2, 2));
            }),
            (n.prototype.getPixelCoordinatesOnPlotArea = function(e, t) {
              return {
                x: this.axisX.getPixelCoordinatesOnAxis(e).x,
                y: this.axisY.getPixelCoordinatesOnAxis(t).y
              };
            }),
            (n.prototype.renderIndexLabels = function(e) {
              for (
                var t = e || this.plotArea.ctx,
                  ...
                  c = 0,
                  x = 0;
                x < this._indexLabels.length;
                x++
              ) {
                var u,
                  m,
                  v = this._indexLabels[x],
                ...
                if (null !== _ && "" !== _) {
                  var A = (0, F.getProperty)(
                    ...
                    B = v.direction,
                    z = v.dataSeries.axisX,
                    D = v.dataSeries.axisY,
                    X = new p["default"](t, {
                      x: 0,
                      y: 0,
                      maxWidth: T ? T : 0.5 * this.width,
                      maxHeight: C ? 5 * f : 1.5 * f,
                      angle: "horizontal" === I ? 0 : -90,
                      text: _,
                      padding: 0,
                      backgroundColor: S,
                      horizontalAlign: "left",
                  ...
                  if (
                    ...
                    if (
                      v.dataPoint.x < z.viewportMinimum ||
                      v.dataPoint.x > z.viewportMaximum ||
              ...
              var Y = {
                source: t,
                dest: this.plotArea.ctx,
                animationCallback: L["default"].fadeInAnimation,
                easingFunction: L["default"].easing.easeInQuad,
                animationBase: 0,
                startTimePercent: 0.7
              };
              return Y;
            }),
            (n.prototype.renderLine = function(e) {
              var t = e.targetCanvasCtx || this.plotArea.ctx,
                i = e.dataSeriesIndexes.length;
              if (!(0 >= i)) {
                ...
                t.save();
                var n = this.plotArea;
                t.beginPath(), t.rect(n.x1, n.y1, n.width, n.height), t.clip();
                for (var s = [], r = 0; r < e.dataSeriesIndexes.length; r++) {
                  var o = e.dataSeriesIndexes[r],
                    l = this.data[o];
                  t.lineWidth = l.lineThickness;
                  var h = l.dataPoints;
                  t.setLineDash &&
                    t.setLineDash(
                      (0, F.getLineDashArray)(l.lineDashType, l.lineThickness)
                    );
                  var d = l.id;
                  ...
                  var c = (0, F.intToHexColorString)(d);
                  (a.strokeStyle = c),
                    (a.lineWidth =
                      l.lineThickness > 0 ? Math.max(l.lineThickness, 4) : 0);
                  var p = l._colorSet,
                    x = p[0];
                  t.strokeStyle = x;
                  var m,
                    ...
                    y = !0,
                    f = 0;
                  if ((t.beginPath(), h.length > 0)) {
                    var b = !1;
                    for (f = 0; f < h.length; f++)
                      if (
                        ((g = h[f].x.getTime ? h[f].x.getTime() : h[f].x),
                        !(
                          g < e.axisX.dataInfo.viewPortMin ||
                          g > e.axisX.dataInfo.viewPortMax
                        ))
                      )
                        if ("number" == typeof h[f].y) {
                          (m =
                            (e.axisX.conversionParameters.reference +
                              e.axisX.conversionParameters.pixelPerUnit *
                                (g - e.axisX.conversionParameters.minimum) +
                          ...
                          if (
                            ...
                            y || b
                              ? (t.beginPath(),
                                t.moveTo(m, v),
                                F.isCanvasSupported &&
                                  (a.beginPath(), a.moveTo(m, v)),
                                (y = !1),
                                (b = !1))
                              : (t.lineTo(m, v),
                                F.isCanvasSupported && a.lineTo(m, v),
                                f % 500 == 0 &&
                                  (t.stroke(),
                                  t.beginPath(),
                                  t.moveTo(m, v),
                                  F.isCanvasSupported &&
                                    ...
                                    a.beginPath(),
                                    a.moveTo(m, v)))),
                            h[f].markerSize > 0 || l.markerSize > 0)
                          ) {
                            var P = l.getMarkerProperties(f, m, v, t);
                            s.push(P);
                            var S = (0, F.intToHexColorString)(M);
                            F.isCanvasSupported &&
                              s.push({
                                x: m,
                                y: v,
                          ...
                          f > 0 &&
                            (t.stroke(), F.isCanvasSupported && a.stroke()),
                            (b = !0);
                    t.stroke(), F.isCanvasSupported && a.stroke();
                  }
                }
                u["default"].drawMarkers(s),
                  t.restore(),
                  t.beginPath(),
                  F.isCanvasSupported && a.beginPath();
                var T = {
                  source: t,
                  dest: this.plotArea.ctx,
                  animationCallback: L["default"].xClipAnimation,
                  easingFunction: L["default"].easing.linear,
                  animationBase: 0
                };
                return T;
              }
            }),
            (n.prototype.renderStepLine = function(e) {
              var t = e.targetCanvasCtx || this.plotArea.ctx,
                i = e.dataSeriesIndexes.length;
              if (!(0 >= i)) {
                var a = this._eventManager.ghostCtx;
                ...
                for (var s = [], r = 0; r < e.dataSeriesIndexes.length; r++) {
                  ...
                  if ((t.beginPath(), h.length > 0)) {
                    ...
                    for (f = 0; f < h.length; f++)
                      if (
                        ((g = h[f].getTime ? h[f].x.getTime() : h[f].x),
                        !(
                          g < e.axisX.dataInfo.viewPortMin ||
                          g > e.axisX.dataInfo.viewPortMax
                        ))
                          ...
                          if (
                            ...
                            y || b
                              ? (t.beginPath(),
                                ...
                                (b = !1))
                              : (t.lineTo(m, M),
                                F.isCanvasSupported && a.lineTo(m, M),
                                t.lineTo(m, v),
                                F.isCanvasSupported && a.lineTo(m, v),
                                f % 500 == 0 &&
                                  (t.stroke(),
                            ...
                            var S = l.getMarkerProperties(f, m, v, t);
                            s.push(S);
                            var T = (0, F.intToHexColorString)(P);
                            F.isCanvasSupported &&
                              s.push({
                                x: m,
                                y: v,
            ...
            (n.prototype.animationRequestId = null),
            ...
            (n.prototype.cancelRequestAnimFrame = (function() {
              return (
            ...
            (n.prototype.getPercentAndTotal = function(e, t) {
              var i = null,
                a = null,
                n = null;
              if (e.type.indexOf("stacked") >= 0)
                (a = 0),
                  (i = t.x.getTime ? t.x.getTime() : t.x),
                  i in e.plotUnit.yTotals &&
            ...
            (n.prototype.replaceKeywordsWithValue = function(e, t, i, a, n) {
              var s = /\{.*?\}|"[^"]*"|'[^']*'/g,
                r = this;
              if (
                ...
                do {
                  ...
                  (e = e.replace(
                    "#percent",
                    (0, F.numberFormat)(o, d, r._cultureInfo)
                  )),
                    (e = e.replace(
                      "#total",
                      (0, F.numberFormat)(
              ...
              var x = function(e) {
                ...
                var s = (0, F.trimString)(e.slice(1, e.length - 1));
                s = s.replace("#index", n);
                var o = null;
                try {
                  var l = s.match(/(.*?)\s*\[\s*(.*?)\s*\]/);
                  l &&
                    l.length > 0 &&
                    ((o = (0, F.trimString)(l[2])),
                    (s = (0, F.trimString)(l[1])));
                } catch (h) {}
                var d = null;
                if ("color" === s)
                  return t.color
            ...
            (n.prototype.renderSpline = z.SplineChart),
            (n.prototype.renderColumn = z.ColumnChart),
            (n.prototype.renderStackedColumn = z.StackedColumnChart),
            (n.prototype.renderStackedColumn100 = z.StackedColumn100Chart),
            (n.prototype.renderBar = z.BarChart),
            (n.prototype.renderStackedBar = z.StackedBarChart),
            (n.prototype.renderStackedBar100 = z.StackedBar100Chart),
            (n.prototype.renderArea = z.AreaChart),
            (n.prototype.renderSplineArea = z.SplineAreaChart),
            (n.prototype.renderStepArea = z.StepAreaChart),
            (n.prototype.renderStackedArea = z.StackedAreaChart),
            (n.prototype.renderStackedArea100 = z.StackedArea100Chart),
            (n.prototype.renderBubble = z.BubbleChart),
            (n.prototype.renderScatter = z.ScatterChart),
            (n.prototype.renderCandlestick = z.CandlestickChart),
            (n.prototype.renderRangeColumn = z.RangeColumnChart),
            (n.prototype.renderRangeBar = z.RangeBarChart),
            (n.prototype.renderRangeArea = z.RangeAreaChart),
            (n.prototype.renderRangeSplineArea = z.RangeSplineAreaChart),
            (n.prototype.renderPie = z.PieChart),
            (i["default"] = n);
        },
        {
          "../charts/index": 6,
      ...
      29: [
        function(e, t, i) {
          ...
          function n(e) {
            var t;
            e && l.cultures[e] && (t = l.cultures[e]),
              n.base.constructor.call(this, "CultureInfo", t);
          }
          Object.defineProperty(i, "__esModule", { value: !0 });
          var s = e("./canvasjs"),
            r = a(s),
            o = e("../helpers/utils"),
            l = e("../constants/culture");
          (0, o.extend)(n, r["default"]), (i["default"] = n);
        },
        { "../constants/culture": 22, "../helpers/utils": 39, "./canvasjs": 27 }
      ],
      30: [
        function(e, t, i) {
          "use strict";
          ...
          function n(e, t, i, a, s) {
            n.base.constructor.call(this, "DataSeries", t, i),
              (this.chart = e),
              (this.canvas = e.canvas),
              ...
              "undefined" == typeof this._options.indexLabelFontSize &&
          ...
          (0, o.extend)(n, r["default"]),
            ...
            (n.getDefaultLegendMarker = function(e) {
              return "column" === e ||
                "stackedColumn" === e ||
                "stackedLine" === e ||
                "bar" === e ||
            ...
            (n.prototype.getDataPointAtX = function(e, t) {
              ...
              for (;;) {
                if (
                  ((s = r > 0 ? c + n : c - n),
                  s >= 0 && s < this.dataPoints.length)
                ) {
                  a = this.dataPoints[s];
                  var x = Math.abs(a.x - e);
                  x < i.distance &&
                    ((i.dataPoint = a), (i.distance = x), (i.index = s));
                  var u = Math.abs(a.x - e);
                  if ((o >= u ? (o = u) : r > 0 ? l++ : h++, l > d && h > d))
                    break;
                } else if (0 > c - n && c + n >= this.dataPoints.length) break;
                -1 === r ? (n++, (r = 1)) : (r = -1);
              }
            ...
            (n.prototype.getDataPointAtXY = function(e, t, i) {
              ...
              var a = [],
                ...
                x = 0;
              if ("none" !== this.chart.plotInfo.axisPlacement) {
                var u = this.chart.axisX.getXValueAt({ x: e, y: t }),
                  m =
                    this.dataPoints[this.dataPoints.length - 1].x -
                    this.dataPoints[0].x;
                x =
              ...
              for (;;) {
                if (
                  ...
                  var v = this.dataPointIds[s],
                    g = this.chart._eventManager.objectMap[v],
                    y = this.dataPoints[s],
                    f = null;
                  if (g) {
                    switch (this.type) {
                      ...
                      case "splineArea":
                      case "scatter":
                        var b = (0, o.getProperty)("markerSize", y, this) || 4,
                          M = i ? 20 : b;
                        (f = Math.sqrt(
                          Math.pow(g.x1 - e, 2) + Math.pow(g.y1 - t, 2)
                        )),
                          M >= f &&
                            a.push({
                              dataPoint: y,
                      ...
                      case "rangeSplineArea":
                        ...
                        (f = Math.min(
                          ...
                          Math.sqrt(
                            Math.pow(g.x1 - e, 2) + Math.pow(g.y2 - t, 2)
                          )
                        )),
                          M >= f &&
                            a.push({
                      ...
                      case "doughnut":
                        ...
                        if (
                          ...
                          0 > w && (w += 2 * Math.PI),
                            (w = Number(
                              (((w / Math.PI * 180) % 360 + 360) % 360).toFixed(
                                12
                              )
                            ));
                          var _ = Number(
                              (
                                ((g.startAngle / Math.PI * 180) % 360 + 360) %
                                360
                              ).toFixed(12)
                            ),
                            A = Number(
                              (
                                ((g.endAngle / Math.PI * 180) % 360 + 360) %
                                360
                              ).toFixed(12)
                            );
                          0 === A && g.endAngle > 1 && (A = 360),
                            _ >= A &&
                              0 !== y.y &&
                              ((A += 360), _ > w && (w += 360)),
                            w > _ &&
                        ...
                        break;
                      case "candlestick":
                        ((e >= g.x1 - g.borderThickness / 2 &&
                          e <= g.x2 + g.borderThickness / 2 &&
                          t >= g.y2 - g.borderThickness / 2 &&
                          t <= g.y3 + g.borderThickness / 2) ||
                          (Math.abs(g.x2 - e + g.x1 - e) < g.borderThickness &&
                            t >= g.y1 &&
                            t <= g.y4)) &&
                          (a.push({
                            dataPoint: y,
                      ...
                      case "ohlc":
                        ((Math.abs(g.x2 - e + g.x1 - e) < g.borderThickness &&
                          ...
                          (e >= g.x1 &&
                            e <= (g.x2 + g.x1) / 2 &&
                            t >= g.y1 - g.borderThickness / 2 &&
                            t <= g.y1 + g.borderThickness / 2) ||
                          (e >= (g.x1 + g.x2) / 2 &&
                            e <= g.x2 &&
                            t >= g.y4 - g.borderThickness / 2 &&
                            t <= g.y4 + g.borderThickness / 2)) &&
                          (a.push({
                            dataPoint: y,
                            dataPointIndex: s,
                ...
                } else if (0 > x - n && x + n >= this.dataPoints.length) break;
                -1 === r ? (n++, (r = 1)) : (r = -1);
              }
              for (var L = null, I = 0; I < a.length; I++)
                L ? a[I].distance <= L.distance && (L = a[I]) : (L = a[I]);
              return L;
            }),
            (n.prototype.getMarkerProperties = function(e, t, i, a) {
              var n = this.dataPoints,
                ...
                l = n[e].markerBorderThickness
                  ...
                  : s.markerBorderThickness
                    ? s.markerBorderThickness
                    : null,
                h = n[e].markerType ? n[e].markerType : s.markerType,
                d = n[e].markerSize ? n[e].markerSize : s.markerSize;
              return {
                x: t,
                y: i,
                ctx: a,
            ...
            (a.prototype.mouseEventHandler = function(e) {
              if ("mousemove" === e.type || "click" === e.type) {
                ...
                if (
                  ...
                  a && "undefined" != typeof this.objectMap[a])
                ) {
              ...
              for (var c = 0; c < this.dataSeries.length; c++) {
                ...
                if (
                  ...
                  for (var M = 0; M < x.dataPoints.length; M++) {
                    ...
                    (P.showInLegend ||
                      (x.showInLegend && P.showInLegend !== !1)) &&
                      l.push(b);
                  }
                b = null;
              }
              if ((this.reversed === !0 && l.reverse(), l.length > 0)) {
                var S = null,
                  T = 0,
                  C = 0,
                  k = 0;
                    ...
                    0 >= o ||
                      ...
                      ("horizontal" === this.orientation
                        ...
                        : ((b.textBlock = new d["default"](this.ctx, {
                            ...
                            maxWidth: C,
                            maxHeight:
                              this.itemWrap === !0 ? o : 1.5 * this.fontSize,
                            angle: 0,
                            text: b.text,
                            horizontalAlign: "left",
                            fontSize: this.fontSize,
      ...
      34: [
        function(e, t, i) {
          ...
          function n(e, t) {
            n.base.constructor.call(this, "TextBlock", t),
              (this.ctx = e),
              (this._isDirty = !0),
              (this._wrappedText = null),
              (this._lineHeight = (0, o.getFontHeightInPixels)(
                this.fontFamily,
                this.fontSize,
                this.fontWeight
              ));
          ...
          (0, o.extend)(n, r["default"]),
            ...
            (n.prototype._getLineWithWidth = function(e, t, i) {
              ...
              var a = 0,
                ...
                s = e.length - 1,
                r = 1 / 0;
              for (this.ctx.font = this._getFontString(); s >= n; ) {
                r = Math.floor((n + s) / 2);
                var o = e.substr(0, r + 1);
                if (((a = this.ctx.measureText(o).width), t > a)) n = r + 1;
                else {
                  if (!(a > t)) break;
                  s = r - 1;
                }
            ...
            (n.prototype._wrapText = function() {
              var e = new String((0, o.trimString)(String(this.text))),
                t = [],
                i = this.ctx.font,
                a = 0,
                n = 0;
              for (this.ctx.font = this._getFontString(); e.length > 0; ) {
                var s = this.maxWidth - 2 * this.padding,
                  r = this.maxHeight - 2 * this.padding,
                ...
                if (
                  ...
                  (a += l.height),
                  (e = (0, o.trimString)(e.slice(l.text.length, e.length))),
                  r && a > r)
                ) {
                  var l = t.pop();
                  a -= l.height;
            ...
            (n.prototype._getFontString = function() {
              return (0, o.getFontString)("", this, null);
            }),
            (i["default"] = n);
        },
        { "../helpers/utils": 39, "./canvasjs": 27 }
              ...
              if (this.text) {
                ...
                "top" === this.verticalAlign || "bottom" === this.verticalAlign
                  ? (null === this.maxWidth &&
                      (this.maxWidth =
                        a.width -
                        2 * h -
                        d * ("center" === this.horizontalAlign ? 2 : 1)),
                    (o = 0.5 * a.height - this.margin - h),
                    (r = 0))
                  : "center" === this.verticalAlign &&
                    ("left" === this.horizontalAlign ||
                    "right" === this.horizontalAlign
                      ? (null === this.maxWidth &&
                          (this.maxWidth = a.height - 2 * h),
                        (o = 0.5 * a.width - this.margin - h))
                      : "center" === this.horizontalAlign &&
                        (null === this.maxWidth &&
                          (this.maxWidth = a.width - 2 * h),
                        (o = 0.5 * a.height - 2 * h))),
                  this.wrap ||
                    (o = Math.min(
                      o,
                ...
                "top" === this.verticalAlign || "bottom" === this.verticalAlign
                  ? ("top" === this.verticalAlign
                      ? ((s = a.y1 + h), (t = "top"))
                      : "bottom" === this.verticalAlign &&
                        ((s = a.y2 - h - p.height), (t = "bottom")),
                    "left" === this.horizontalAlign
                      ? (n = a.x1 + h)
                      : "center" === this.horizontalAlign
                        ? (n = a.x1 + a.width / 2 - p.width / 2)
                        : "right" === this.horizontalAlign &&
                          (n = a.x2 - h - p.width - d),
                  ...
                  : "center" === this.verticalAlign &&
                    ("left" === this.horizontalAlign
                      ? ((n = a.x1 + h),
                        (s = a.y2 - h - (this.maxWidth / 2 - p.width / 2)),
                        (r = -90),
                        (t = "left"),
                        (this.width = p.height),
                        (this.height = p.width))
                      : "right" === this.horizontalAlign
                        ? ((n = a.x2 - h),
                          (s = a.y1 + h + (this.maxWidth / 2 - p.width / 2)),
                          (r = 90),
                          (t = "right"),
                          (this.width = p.height),
                          (this.height = p.width))
                        : "center" === this.horizontalAlign &&
                          ((s = i.y1 + (i.height / 2 - p.height / 2)),
                          (n = i.x1 + (i.width / 2 - p.width / 2)),
                          (t = "center"),
                          (this.width = p.width),
                          (this.height = p.height)),
                    (e = "center")),
                  ...
                  i.layoutManager.registerSpace(t, {
                    width:
                      this.width +
                      ("left" === t || "right" === t ? this.margin + h : 0),
                    height:
                      this.height +
                      ("top" === t || "bottom" === t ? this.margin + h : 0)
                  }),
                  (this.bounds = {
                    x1: n,
                    y1: s,
          ...
          (0, d.extend)(n, h["default"]),
            ...
            (n.prototype._updateToolTip = function(e, t) {
              if (!this.chart.disableToolTip) {
                ...
                if (
                  ...
                  if (p)
                    ...
                    if (
                      x > 0 &&
                      "undefined" !=
                        typeof this.chart._eventManager.objectMap[x]
                    ) {
                ...
                if (s.length > 0 && (this.highlightObjects(s), this.enabled)) {
                  var v = "";
                  if (
                    ((v = this.getToolTipInnerHTML({ entries: s })), null !== v)
                  ) {
                    ...
                    "stackedBar100" === s[0].dataSeries.type
                      ? (f = e - 10 - this.container.clientWidth)
                      : ((f =
                          ...
                          0),
                        (f -= 10)),
                      0 > f && (f += this.container.clientWidth + 20),
                      f + this.container.clientWidth >
            ...
            (n.prototype.highlightObjects = function(e) {
              ...
              for (var n = 0; n < e.length; n++) {
                var s = e[n],
                  r = this.chart._eventManager.objectMap[
                ...
                if (r && r.objectType && "dataPoint" === r.objectType) {
                  var l = this.chart.data[r.dataSeriesIndex],
                    ...
                    c = r.dataPointIndex;
                  if (
                    h.highlightEnabled !== !1 &&
                    (l.highlightEnabled === !0 || h.highlightEnabled === !0)
                  )
                    if (
                      "line" === l.type ||
                      "stepLine" === l.type ||
        ...
        function(e, t, i) {
          ...
          var a = {
            drawMarker: function(e, t, i, a, n, s, r, o) {
              if (i) {
                var l = 1;
                (i.fillStyle = s ? s : "#000000"),
                  (i.strokeStyle = r ? r : "#000000"),
                  (i.lineWidth = o ? o : 0),
                  "circle" === a
                    ? (i.moveTo(e, t),
                      i.beginPath(),
      ...
      39: [
        function(e, t, i) {
                      ...
                      : "day" === i
                        ...
                        : "week" === i
                          ...
                          : "month" === i
                            ...
                            : "year" === i &&
                              e.setFullYear(e.getFullYear() + 1 * t),
              e
            );
          }
          function r(e, t) {
            ...
            if (isNaN(n)) {
              try {
                ...
                if (!Y) {
                  ...
                  Y.appendChild(o), r.appendChild(Y);
                }
                (Y.style.display = ""),
                  Y.setAttribute("style", s),
                  (n = Math.round(Y.offsetHeight)),
                  (Y.style.display = "none");
              } catch (l) {
                n = Math.ceil(1.1 * t);
              }
              (n = Math.max(n, t)), (X[a] = n);
            }
            return n;
          }
          function y(e, t) {
            ...
            if ((i = a[e])) for (var n = 0; n < i.length; n++) i[n] *= t;
            else i = [];
            return i;
          }
          function f(e, t, i, a) {
          ...
          function b() {
            var e = /D{1,4}|M{1,4}|Y{1,4}|h{1,2}|H{1,2}|m{1,2}|s{1,2}|f{1,3}|t{1,2}|T{1,2}|K|z{1,3}|"[^"]*"|'[^']*'/g,
              t = [
                "Sunday",
                "Monday",
                "Tuesday",
            ...
            return function(l, h, d) {
              ...
              "UTC:" === h.slice(0, 4) && ((h = h.slice(4)), (v = !0));
              var g = v ? "getUTC" : "get",
                y = l[g + "Date"](),
                f = l[g + "Day"](),
                b = l[g + "Month"](),
                ...
                T = l[g + "Seconds"](),
                C = l[g + "Milliseconds"](),
                k = v ? 0 : l.getTimezoneOffset();
              return (m = h.replace(e, function(e) {
                switch (e) {
                  case "D":
                    return y;
                  case "DD":
                  ...
                  case "MMMM":
                    return p[b];
                  case "Y":
                    return parseInt(String(M).slice(-2));
                  case "YY":
                    return o(String(M).slice(-2), 2);
                  case "YYY":
                    return o(String(M).slice(-3), 3);
                  case "YYYY":
                    return o(M, 4);
                  case "h":
                    return P % 12 || 12;
                  ...
                  case "ff":
                    return o(String(C).slice(0, 2), 2);
                  case "fff":
                    return o(String(C).slice(0, 3), 3);
                  case "t":
                    return 12 > P ? "a" : "p";
                  case "tt":
                    return 12 > P ? "am" : "pm";
                  ...
                  case "zz":
                    return (
                      (k > 0 ? "-" : "+") + o(Math.floor(Math.abs(k) / 60), 2)
                    );
                  case "zzz":
                    return (
                      (k > 0 ? "-" : "+") +
                      o(Math.floor(Math.abs(k) / 60), 2) +
                      o(Math.abs(k) % 60, 2)
                    );
                  default:
                    return e.slice(1, e.length - 1);
          ...
          function I() {
            for (var e = null, t = 0; t < arguments.length; t++)
              (e = arguments[t]), e && e.style && (e.style.display = "none");
          }
          function B(e, t) {
          ...
          function F(e, t) {
            if (null === e || "undefined" == typeof e) return t;
            var i =
              parseFloat(e.toString()) *
              (e.toString().indexOf("%") >= 0 ? t / 100 : 1);
            return !isNaN(i) && t >= i && i >= 0 ? i : t;
          }
          function z(e, t, i, a, n, s, r, o, l, h, d, c, p) {
          ...
          function D(e, t, i, a, n, s, r, o, l) {
            if (("undefined" == typeof o && (o = 1), !V)) {
              var h = Number((r % (2 * Math.PI)).toFixed(8)),
                d = Number((s % (2 * Math.PI)).toFixed(8));
              d === h && (r -= 1e-4);
            }
            e.save(),
              (e.globalAlpha = o),
          ...
          var X = {},
            ...
            V = (i.isCanvasSupported = !!document.createElement("canvas")
              .getContext);
        },
        {}
      ],
      40: [
        function(e, t, i) {
          ...
          Object.defineProperty(i, "__esModule", { value: !0 }),
            (i.formatDate = i.formatNumber = i.addCultureInfo = i.addColorSet = void 0),
            (i.Chart = n);
          var s = e("../core/charts"),
            r = a(s),
